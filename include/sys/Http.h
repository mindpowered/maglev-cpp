...
class HXCPP_CLASS_ATTRIBUTES Http_obj : public  ::haxe::http::HttpBase_obj
{
	...
	public:
		...
		void fileTransfert(::String argname,::String filename, ::haxe::io::Input file,int size,::String mimeType);
		::Dynamic fileTransfert_dyn();

		void fileTransfer(::String argname,::String filename, ::haxe::io::Input file,int size,::String mimeType);
		::Dynamic fileTransfer_dyn();

...
HX_DEFINE_STACK_FRAME(_hx_pos_e0c24b68701883be_44_new,"haxe.xml.Printer","new",0x896dce4d,"haxe.xml.Printer.new","/opt/haxe/std/haxe/xml/Printer.hx",44,0x702324bb)
HX_LOCAL_STACK_FRAME(_hx_pos_e0c24b68701883be_50_writeNode,"haxe.xml.Printer","writeNode",0x6952ac2e,"haxe.xml.Printer.writeNode","/opt/haxe/std/haxe/xml/Printer.hx",50,0x702324bb)
...
HX_LOCAL_STACK_FRAME(_hx_pos_e0c24b68701883be_105_write,"haxe.xml.Printer","write",0x5260800c,"haxe.xml.Printer.write","/opt/haxe/std/haxe/xml/Printer.hx",105,0x702324bb)
HX_LOCAL_STACK_FRAME(_hx_pos_e0c24b68701883be_109_newline,"haxe.xml.Printer","newline",0x6cfa90c1,"haxe.xml.Printer.newline","/opt/haxe/std/haxe/xml/Printer.hx",109,0x702324bb)
static const ::String _hx_array_data_d3e3a3db_20[] = {
	HX_("\n",0a,00,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_e0c24b68701883be_114_hasChildren,"haxe.xml.Printer","hasChildren",0xeb7e31a6,"haxe.xml.Printer.hasChildren","/opt/haxe/std/haxe/xml/Printer.hx",114,0x702324bb)
HX_LOCAL_STACK_FRAME(_hx_pos_e0c24b68701883be_35_print,"haxe.xml.Printer","print",0x4a926b5a,"haxe.xml.Printer.print","/opt/haxe/std/haxe/xml/Printer.hx",35,0x702324bb)
namespace haxe{
namespace xml{

void Printer_obj::__construct(bool pretty){
            	HX_GC_STACKFRAME(&_hx_pos_e0c24b68701883be_44_new)
...
void Printer_obj::writeNode( ::Xml value,::String tabs){
            	HX_GC_STACKFRAME(&_hx_pos_e0c24b68701883be_50_writeNode)
...
void Printer_obj::write(::String input){
            	HX_STACKFRAME(&_hx_pos_e0c24b68701883be_105_write)
...
void Printer_obj::newline(){
            	HX_STACKFRAME(&_hx_pos_e0c24b68701883be_109_newline)
...
HXLINE( 110)				_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_d3e3a3db_20,1);
            			}
            			else {
...
bool Printer_obj::hasChildren( ::Xml value){
            	HX_STACKFRAME(&_hx_pos_e0c24b68701883be_114_hasChildren)
HXLINE( 115)		{
...
::String Printer_obj::print( ::Xml xml, ::Dynamic __o_pretty){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_e0c24b68701883be_35_print)

...
HX_LOCAL_STACK_FRAME(_hx_pos_4c3c4b35a7d1d0e1_36_parseString,"haxe.Int64Helper","parseString",0x30544f49,"haxe.Int64Helper.parseString","/opt/haxe/std/haxe/Int64Helper.hx",36,0x16ff3182)
HX_LOCAL_STACK_FRAME(_hx_pos_4c3c4b35a7d1d0e1_79_fromFloat,"haxe.Int64Helper","fromFloat",0xe14c7677,"haxe.Int64Helper.fromFloat","/opt/haxe/std/haxe/Int64Helper.hx",79,0x16ff3182)
namespace haxe{
...
bool Int64Helper_obj::_hx_isInstanceOf(int inClassId) {
 ...
 cpp::Int64Struct Int64Helper_obj::parseString(::String sParam){
            	HX_STACKFRAME(&_hx_pos_4c3c4b35a7d1d0e1_36_parseString)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Int64Helper_obj,parseString,return )
 ...
 cpp::Int64Struct Int64Helper_obj::fromFloat(Float f){
            	HX_STACKFRAME(&_hx_pos_4c3c4b35a7d1d0e1_79_fromFloat)
...
HXLINE(  81)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Number is NaN or Infinite",2d,21,08,80)));
            		}
HXLINE(  84)		Float noFractions = (f - ::hx::Mod(f,1));
HXLINE(  90)		if ((noFractions > ((Float)9007199254740991))) {
HXLINE(  91)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Conversion overflow",6c,95,02,46)));
            		}
HXLINE(  93)		if ((noFractions < ((Float)-9007199254740991))) {
HXLINE(  94)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Conversion underflow",9c,47,f1,ac)));
            		}
HXLINE(  97)		 cpp::Int64Struct result = ( ::cpp::Int64Struct(0));
...
HXLINE( 106)				result = _hx_int64_add(result,_hx_int64_shl(( ::cpp::Int64Struct(1)),i));
            			}
HXLINE( 108)			i = (i + 1);
            		}
HXLINE( 111)		if (neg) {

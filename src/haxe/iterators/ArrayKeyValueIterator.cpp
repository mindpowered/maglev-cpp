...
HX_LOCAL_STACK_FRAME(_hx_pos_eefbb444540c7293_37_hasNext,"haxe.iterators.ArrayKeyValueIterator","hasNext",0x73cdeb47,"haxe.iterators.ArrayKeyValueIterator.hasNext","/opt/haxe/std/haxe/iterators/ArrayKeyValueIterator.hx",37,0xf73563ae)
HX_LOCAL_STACK_FRAME(_hx_pos_eefbb444540c7293_42_next,"haxe.iterators.ArrayKeyValueIterator","next",0xf1b472d9,"haxe.iterators.ArrayKeyValueIterator.next","/opt/haxe/std/haxe/iterators/ArrayKeyValueIterator.hx",42,0xf73563ae)
namespace haxe{
namespace iterators{

void ArrayKeyValueIterator_obj::__construct(::cpp::VirtualArray array){
            	HX_STACKFRAME(&_hx_pos_eefbb444540c7293_26_new)
...
bool ArrayKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_eefbb444540c7293_37_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(ArrayKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic ArrayKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_eefbb444540c7293_42_next)

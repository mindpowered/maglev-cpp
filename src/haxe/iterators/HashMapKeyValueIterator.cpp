...
HX_DEFINE_STACK_FRAME(_hx_pos_184c89d7fa3a72bb_9_new,"haxe.iterators.HashMapKeyValueIterator","new",0xbda62d4f,"haxe.iterators.HashMapKeyValueIterator.new","/opt/haxe/std/haxe/iterators/HashMapKeyValueIterator.hx",9,0x2ab62f39)
HX_LOCAL_STACK_FRAME(_hx_pos_184c89d7fa3a72bb_18_hasNext,"haxe.iterators.HashMapKeyValueIterator","hasNext",0x60bba5dc,"haxe.iterators.HashMapKeyValueIterator.hasNext","/opt/haxe/std/haxe/iterators/HashMapKeyValueIterator.hx",18,0x2ab62f39)
HX_LOCAL_STACK_FRAME(_hx_pos_184c89d7fa3a72bb_24_next,"haxe.iterators.HashMapKeyValueIterator","next",0x33c17924,"haxe.iterators.HashMapKeyValueIterator.next","/opt/haxe/std/haxe/iterators/HashMapKeyValueIterator.hx",24,0x2ab62f39)
namespace haxe{
namespace iterators{

void HashMapKeyValueIterator_obj::__construct( ::haxe::ds::_HashMap::HashMapData map){
            	HX_STACKFRAME(&_hx_pos_184c89d7fa3a72bb_9_new)
...
bool HashMapKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_184c89d7fa3a72bb_18_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(HashMapKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic HashMapKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_184c89d7fa3a72bb_24_next)

...
HX_LOCAL_STACK_FRAME(_hx_pos_43dea4fba9405cd8_44_hasNext,"haxe.iterators.MapKeyValueIterator","hasNext",0x6e75ff8a,"haxe.iterators.MapKeyValueIterator.hasNext","/opt/haxe/std/haxe/iterators/MapKeyValueIterator.hx",44,0xdcdcb84b)
HX_LOCAL_STACK_FRAME(_hx_pos_43dea4fba9405cd8_50_next,"haxe.iterators.MapKeyValueIterator","next",0x951a66b6,"haxe.iterators.MapKeyValueIterator.next","/opt/haxe/std/haxe/iterators/MapKeyValueIterator.hx",50,0xdcdcb84b)
namespace haxe{
namespace iterators{

void MapKeyValueIterator_obj::__construct(::Dynamic map){
            	HX_STACKFRAME(&_hx_pos_43dea4fba9405cd8_35_new)
...
bool MapKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_43dea4fba9405cd8_44_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(MapKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic MapKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_43dea4fba9405cd8_50_next)

...
HX_LOCAL_STACK_FRAME(_hx_pos_2dcd5cbcaa98c3ab_45_hasNext,"haxe.iterators.ArrayIterator","hasNext",0x74587dd5,"haxe.iterators.ArrayIterator.hasNext","/opt/haxe/std/haxe/iterators/ArrayIterator.hx",45,0x39f8e3e0)
HX_LOCAL_STACK_FRAME(_hx_pos_2dcd5cbcaa98c3ab_53_next,"haxe.iterators.ArrayIterator","next",0x21c2db8b,"haxe.iterators.ArrayIterator.next","/opt/haxe/std/haxe/iterators/ArrayIterator.hx",53,0x39f8e3e0)
namespace haxe{
namespace iterators{

void ArrayIterator_obj::__construct(::cpp::VirtualArray array){
            	HX_STACKFRAME(&_hx_pos_2dcd5cbcaa98c3ab_28_new)
...
bool ArrayIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_2dcd5cbcaa98c3ab_45_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(ArrayIterator_obj,hasNext,return )
 ...
 ::Dynamic ArrayIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_2dcd5cbcaa98c3ab_53_next)

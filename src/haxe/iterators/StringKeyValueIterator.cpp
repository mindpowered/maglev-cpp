...
HX_LOCAL_STACK_FRAME(_hx_pos_bc82f9e51be3c897_46_hasNext,"haxe.iterators.StringKeyValueIterator","hasNext",0x301ba341,"haxe.iterators.StringKeyValueIterator.hasNext","/opt/haxe/std/haxe/iterators/StringKeyValueIterator.hx",46,0x4a21de84)
HX_LOCAL_STACK_FRAME(_hx_pos_bc82f9e51be3c897_53_next,"haxe.iterators.StringKeyValueIterator","next",0x0a115a9f,"haxe.iterators.StringKeyValueIterator.next","/opt/haxe/std/haxe/iterators/StringKeyValueIterator.hx",53,0x4a21de84)
namespace haxe{
namespace iterators{
...
bool StringKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_bc82f9e51be3c897_46_hasNext)
HXDLIN(  46)		return (this->offset < this->s.length);
            	}


HX_DEFINE_DYNAMIC_FUNC0(StringKeyValueIterator_obj,hasNext,return )

 ::Dynamic StringKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_bc82f9e51be3c897_53_next)
...
HX_DEFINE_DYNAMIC_FUNC0(StringKeyValueIterator_obj,next,return )

...
HX_LOCAL_STACK_FRAME(_hx_pos_26167a496050a8e9_49_unwrap,"haxe.Exception","unwrap",0x6c26184a,"haxe.Exception.unwrap","/opt/haxe/std/cpp/_std/haxe/Exception.hx",49,0xcf5fdbc3)
HX_LOCAL_STACK_FRAME(_hx_pos_26167a496050a8e9_53_toString,"haxe.Exception","toString",0x11a32013,"haxe.Exception.toString","/opt/haxe/std/cpp/_std/haxe/Exception.hx",53,0xcf5fdbc3)
HX_LOCAL_STACK_FRAME(_hx_pos_26167a496050a8e9_57_details,"haxe.Exception","details",0x13a1b73b,"haxe.Exception.details","/opt/haxe/std/cpp/_std/haxe/Exception.hx",57,0xcf5fdbc3)
HX_LOCAL_STACK_FRAME(_hx_pos_26167a496050a8e9_63___shiftStack,"haxe.Exception","__shiftStack",0x45445d6d,"haxe.Exception.__shiftStack","/opt/haxe/std/cpp/_std/haxe/Exception.hx",63,0xcf5fdbc3)
HX_LOCAL_STACK_FRAME(_hx_pos_26167a496050a8e9_67_get_message,"haxe.Exception","get_message",0x7b47a0d7,"haxe.Exception.get_message","/opt/haxe/std/cpp/_std/haxe/Exception.hx",67,0xcf5fdbc3)
HX_LOCAL_STACK_FRAME(_hx_pos_26167a496050a8e9_71_get_previous,"haxe.Exception","get_previous",0x5217ff27,"haxe.Exception.get_previous","/opt/haxe/std/cpp/_std/haxe/Exception.hx",71,0xcf5fdbc3)
HX_LOCAL_STACK_FRAME(_hx_pos_26167a496050a8e9_75_get_native,"haxe.Exception","get_native",0xdd187087,"haxe.Exception.get_native","/opt/haxe/std/cpp/_std/haxe/Exception.hx",75,0xcf5fdbc3)
HX_LOCAL_STACK_FRAME(_hx_pos_26167a496050a8e9_79_get_stack,"haxe.Exception","get_stack",0xfc45ee58,"haxe.Exception.get_stack","/opt/haxe/std/cpp/_std/haxe/Exception.hx",79,0xcf5fdbc3)
HX_LOCAL_STACK_FRAME(_hx_pos_26167a496050a8e9_19_caught,"haxe.Exception","caught",0xbc294f23,"haxe.Exception.caught","/opt/haxe/std/cpp/_std/haxe/Exception.hx",19,0xcf5fdbc3)
HX_LOCAL_STACK_FRAME(_hx_pos_26167a496050a8e9_27_thrown,"haxe.Exception","thrown",0x8e12fc2f,"haxe.Exception.thrown","/opt/haxe/std/cpp/_std/haxe/Exception.hx",27,0xcf5fdbc3)
namespace haxe{

void Exception_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_26167a496050a8e9_5_new)
...
bool Exception_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Exception_obj::unwrap(){
            	HX_STACKFRAME(&_hx_pos_26167a496050a8e9_49_unwrap)
...
::String Exception_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_26167a496050a8e9_53_toString)
...
::String Exception_obj::details(){
            	HX_STACKFRAME(&_hx_pos_26167a496050a8e9_57_details)
HXDLIN(  57)		if (::hx::IsNull( this->get_previous() )) {
HXDLIN(  57)			::String _hx_tmp = (HX_("Exception: ",95,cc,ac,54) + this->get_message());
HXDLIN(  57)			::Array< ::Dynamic> tmp = this->get_stack();
HXDLIN(  57)			::String _hx_tmp1;
HXDLIN(  57)			if (::hx::IsNull( tmp )) {
HXDLIN(  57)				_hx_tmp1 = HX_("null",87,9e,0e,49);
            			}
            			else {
HXDLIN(  57)				_hx_tmp1 = ::haxe::_CallStack::CallStack_Impl__obj::toString(tmp);
            			}
HXDLIN(  57)			return (_hx_tmp + _hx_tmp1);
            		}
            		else {
HXDLIN(  57)			::String result = HX_("",00,00,00,00);
HXDLIN(  57)			 ::haxe::Exception e = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  57)			 ::haxe::Exception prev = null();
HXDLIN(  57)			while(::hx::IsNotNull( e )){
HXDLIN(  57)				if (::hx::IsNull( prev )) {
HXDLIN(  57)					::String result1 = (HX_("Exception: ",95,cc,ac,54) + e->get_message());
HXDLIN(  57)					::Array< ::Dynamic> tmp = e->get_stack();
HXDLIN(  57)					::String result2;
HXDLIN(  57)					if (::hx::IsNull( tmp )) {
HXDLIN(  57)						result2 = HX_("null",87,9e,0e,49);
            					}
            					else {
HXDLIN(  57)						result2 = ::haxe::_CallStack::CallStack_Impl__obj::toString(tmp);
            					}
HXDLIN(  57)					result = ((result1 + result2) + result);
            				}
            				else {
HXDLIN(  57)					::Array< ::Dynamic> prevStack = e->get_stack();
HXDLIN(  57)					::Array< ::Dynamic> prevStack1 = ::haxe::_CallStack::CallStack_Impl__obj::subtract(prevStack,prev->get_stack());
HXDLIN(  57)					::String result1 = (HX_("Exception: ",95,cc,ac,54) + e->get_message());
HXDLIN(  57)					::String result2;
HXDLIN(  57)					if (::hx::IsNull( prevStack1 )) {
HXDLIN(  57)						result2 = HX_("null",87,9e,0e,49);
            					}
            					else {
HXDLIN(  57)						result2 = ::haxe::_CallStack::CallStack_Impl__obj::toString(prevStack1);
            					}
HXDLIN(  57)					result = (((result1 + result2) + HX_("\n\nNext ",ed,7e,c7,cb)) + result);
            				}
HXDLIN(  57)				prev = e;
HXDLIN(  57)				e = e->get_previous();
            			}
...
void Exception_obj::_hx___shiftStack(){
            	HX_STACKFRAME(&_hx_pos_26167a496050a8e9_63___shiftStack)
HXDLIN(  63)		this->_hx___skipStack++;
            	}
...
::String Exception_obj::get_message(){
            	HX_STACKFRAME(&_hx_pos_26167a496050a8e9_67_get_message)
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_message,return )
 ...
 ::haxe::Exception Exception_obj::get_previous(){
            	HX_STACKFRAME(&_hx_pos_26167a496050a8e9_71_get_previous)
HXDLIN(  71)		return this->_hx___previousException;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_previous,return )
 ...
 ::Dynamic Exception_obj::get_native(){
            	HX_STACKFRAME(&_hx_pos_26167a496050a8e9_75_get_native)
...
::Array< ::Dynamic> Exception_obj::get_stack(){
            	HX_STACKFRAME(&_hx_pos_26167a496050a8e9_79_get_stack)
HXDLIN(  79)		::Array< ::Dynamic> _g = this->_hx___exceptionStack;
HXLINE(  80)		if (::hx::IsNull( _g )) {
HXLINE(  80)			return (this->_hx___exceptionStack = ::haxe::NativeStackTrace_obj::toHaxe(this->_hx___nativeStack,this->_hx___skipStack));
            		}
            		else {
HXLINE(  81)			::Array< ::Dynamic> s = _g;
HXDLIN(  81)			return s;
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_stack,return )
 ...
 ::haxe::Exception Exception_obj::caught( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_26167a496050a8e9_19_caught)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Exception_obj,caught,return )
 ...
 ::Dynamic Exception_obj::thrown( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_26167a496050a8e9_27_thrown)

...
HX_LOCAL_STACK_FRAME(_hx_pos_884aa1fb6b3b7ff9_60_stringify,"haxe.Json","stringify",0x9504336d,"haxe.Json.stringify","/opt/haxe/std/haxe/Json.hx",60,0x9afd6c97)
namespace haxe{
...
bool Json_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Json_obj::parse(::String text){
            	HX_GC_STACKFRAME(&_hx_pos_884aa1fb6b3b7ff9_44_parse)
...
::String Json_obj::stringify( ::Dynamic value, ::Dynamic replacer,::String space){
            	HX_STACKFRAME(&_hx_pos_884aa1fb6b3b7ff9_60_stringify)

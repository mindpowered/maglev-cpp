...
HX_DEFINE_STACK_FRAME(_hx_pos_b7c80bf9e5992167_76_new,"haxe.io.Path","new",0x1b96d677,"haxe.io.Path.new","/opt/haxe/std/haxe/io/Path.hx",76,0x7badef2f)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_115_toString,"haxe.io.Path","toString",0xc0ab5735,"haxe.io.Path.toString","/opt/haxe/std/haxe/io/Path.hx",115,0x7badef2f)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_123_withoutExtension,"haxe.io.Path","withoutExtension",0xb4016fa0,"haxe.io.Path.withoutExtension","/opt/haxe/std/haxe/io/Path.hx",123,0x7badef2f)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_134_withoutDirectory,"haxe.io.Path","withoutDirectory",0xdf35ce8e,"haxe.io.Path.withoutDirectory","/opt/haxe/std/haxe/io/Path.hx",134,0x7badef2f)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_147_directory,"haxe.io.Path","directory",0xbcfe23c4,"haxe.io.Path.directory","/opt/haxe/std/haxe/io/Path.hx",147,0x7badef2f)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_161_extension,"haxe.io.Path","extension",0x91c9c4d6,"haxe.io.Path.extension","/opt/haxe/std/haxe/io/Path.hx",161,0x7badef2f)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_175_withExtension,"haxe.io.Path","withExtension",0x256d3570,"haxe.io.Path.withExtension","/opt/haxe/std/haxe/io/Path.hx",175,0x7badef2f)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_189_join,"haxe.io.Path","join",0x05c781f3,"haxe.io.Path.join","/opt/haxe/std/haxe/io/Path.hx",189,0x7badef2f)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_210_normalize,"haxe.io.Path","normalize",0x585a68e4,"haxe.io.Path.normalize","/opt/haxe/std/haxe/io/Path.hx",210,0x7badef2f)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_271_addTrailingSlash,"haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","/opt/haxe/std/haxe/io/Path.hx",271,0x7badef2f)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_299_removeTrailingSlashes,"haxe.io.Path","removeTrailingSlashes",0x2dc73462,"haxe.io.Path.removeTrailingSlashes","/opt/haxe/std/haxe/io/Path.hx",299,0x7badef2f)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_314_isAbsolute,"haxe.io.Path","isAbsolute",0xb396db4a,"haxe.io.Path.isAbsolute","/opt/haxe/std/haxe/io/Path.hx",314,0x7badef2f)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_326_unescape,"haxe.io.Path","unescape",0x655df923,"haxe.io.Path.unescape","/opt/haxe/std/haxe/io/Path.hx",326,0x7badef2f)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_324_unescape,"haxe.io.Path","unescape",0x655df923,"haxe.io.Path.unescape","/opt/haxe/std/haxe/io/Path.hx",324,0x7badef2f)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_331_escape,"haxe.io.Path","escape",0xf1f2e5ca,"haxe.io.Path.escape","/opt/haxe/std/haxe/io/Path.hx",331,0x7badef2f)
HX_LOCAL_STACK_FRAME(_hx_pos_b7c80bf9e5992167_329_escape,"haxe.io.Path","escape",0xf1f2e5ca,"haxe.io.Path.escape","/opt/haxe/std/haxe/io/Path.hx",329,0x7badef2f)
namespace haxe{
namespace io{

void Path_obj::__construct(::String path){
            	HX_STACKFRAME(&_hx_pos_b7c80bf9e5992167_76_new)
...
::String Path_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_b7c80bf9e5992167_115_toString)
...
::String Path_obj::withoutExtension(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_b7c80bf9e5992167_123_withoutExtension)
...
::String Path_obj::withoutDirectory(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_b7c80bf9e5992167_134_withoutDirectory)
...
::String Path_obj::directory(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_b7c80bf9e5992167_147_directory)
...
::String Path_obj::extension(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_b7c80bf9e5992167_161_extension)
...
::String Path_obj::withExtension(::String path,::String ext){
            	HX_GC_STACKFRAME(&_hx_pos_b7c80bf9e5992167_175_withExtension)
...
::String Path_obj::join(::Array< ::String > paths){
            	HX_STACKFRAME(&_hx_pos_b7c80bf9e5992167_189_join)
...
::String Path_obj::normalize(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_b7c80bf9e5992167_210_normalize)
...
::String Path_obj::addTrailingSlash(::String path){
            	HX_STACKFRAME(&_hx_pos_b7c80bf9e5992167_271_addTrailingSlash)
...
::String Path_obj::removeTrailingSlashes(::String path){
            	HX_STACKFRAME(&_hx_pos_b7c80bf9e5992167_299_removeTrailingSlashes)
...
bool Path_obj::isAbsolute(::String path){
            	HX_STACKFRAME(&_hx_pos_b7c80bf9e5992167_314_isAbsolute)
...
::String Path_obj::unescape(::String path){
            		...
            		::String _hx_run( ::EReg regex){
            			HX_GC_STACKFRAME(&_hx_pos_b7c80bf9e5992167_326_unescape)
HXLINE( 326)			return ::String::fromCharCode(( (int)(::Std_obj::parseInt(regex->matched(1))) ));
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_GC_STACKFRAME(&_hx_pos_b7c80bf9e5992167_324_unescape)

...
HX_DEFINE_STACK_FRAME(_hx_pos_23f067df91d1840b_40_new,"haxe.io.BytesOutput","new",0x130b775e,"haxe.io.BytesOutput.new","/opt/haxe/std/haxe/io/BytesOutput.hx",40,0xd802aa3c)
HX_LOCAL_STACK_FRAME(_hx_pos_23f067df91d1840b_48_get_length,"haxe.io.BytesOutput","get_length",0xc7c55971,"haxe.io.BytesOutput.get_length","/opt/haxe/std/haxe/io/BytesOutput.hx",48,0xd802aa3c)
HX_LOCAL_STACK_FRAME(_hx_pos_23f067df91d1840b_55_writeByte,"haxe.io.BytesOutput","writeByte",0xed1b0d05,"haxe.io.BytesOutput.writeByte","/opt/haxe/std/haxe/io/BytesOutput.hx",55,0xd802aa3c)
HX_LOCAL_STACK_FRAME(_hx_pos_23f067df91d1840b_59_writeBytes,"haxe.io.BytesOutput","writeBytes",0x8a9057ce,"haxe.io.BytesOutput.writeBytes","/opt/haxe/std/haxe/io/BytesOutput.hx",59,0xd802aa3c)
HX_LOCAL_STACK_FRAME(_hx_pos_23f067df91d1840b_143_getBytes,"haxe.io.BytesOutput","getBytes",0x9fe35837,"haxe.io.BytesOutput.getBytes","/opt/haxe/std/haxe/io/BytesOutput.hx",143,0xd802aa3c)
namespace haxe{
namespace io{

void BytesOutput_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_23f067df91d1840b_40_new)
...
int BytesOutput_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_23f067df91d1840b_48_get_length)
...
void BytesOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_23f067df91d1840b_55_writeByte)
HXDLIN(  55)		this->b->b->push(c);
            	}


int BytesOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_23f067df91d1840b_59_writeBytes)
HXLINE(  65)		{
...
HXLINE(  67)		return len;
 ...
 ::haxe::io::Bytes BytesOutput_obj::getBytes(){
            	HX_STACKFRAME(&_hx_pos_23f067df91d1840b_143_getBytes)

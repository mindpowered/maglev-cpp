...
HX_DEFINE_STACK_FRAME(_hx_pos_a75c3e49aaf71ae1_33_new,"haxe.crypto.BaseCode","new",0xd63c60f5,"haxe.crypto.BaseCode.new","/opt/haxe/std/haxe/crypto/BaseCode.hx",33,0xa8a048f1)
HX_LOCAL_STACK_FRAME(_hx_pos_a75c3e49aaf71ae1_44_encodeBytes,"haxe.crypto.BaseCode","encodeBytes",0x58a8e40a,"haxe.crypto.BaseCode.encodeBytes","/opt/haxe/std/haxe/crypto/BaseCode.hx",44,0xa8a048f1)
HX_LOCAL_STACK_FRAME(_hx_pos_a75c3e49aaf71ae1_72_initTable,"haxe.crypto.BaseCode","initTable",0xa1288133,"haxe.crypto.BaseCode.initTable","/opt/haxe/std/haxe/crypto/BaseCode.hx",72,0xa8a048f1)
HX_LOCAL_STACK_FRAME(_hx_pos_a75c3e49aaf71ae1_81_decodeBytes,"haxe.crypto.BaseCode","decodeBytes",0x152c41f2,"haxe.crypto.BaseCode.decodeBytes","/opt/haxe/std/haxe/crypto/BaseCode.hx",81,0xa8a048f1)
HX_LOCAL_STACK_FRAME(_hx_pos_a75c3e49aaf71ae1_116_encodeString,"haxe.crypto.BaseCode","encodeString",0x24df7852,"haxe.crypto.BaseCode.encodeString","/opt/haxe/std/haxe/crypto/BaseCode.hx",116,0xa8a048f1)
HX_LOCAL_STACK_FRAME(_hx_pos_a75c3e49aaf71ae1_124_decodeString,"haxe.crypto.BaseCode","decodeString",0x5b4e456a,"haxe.crypto.BaseCode.decodeString","/opt/haxe/std/haxe/crypto/BaseCode.hx",124,0xa8a048f1)
HX_LOCAL_STACK_FRAME(_hx_pos_a75c3e49aaf71ae1_128_encode,"haxe.crypto.BaseCode","encode",0x56322ca1,"haxe.crypto.BaseCode.encode","/opt/haxe/std/haxe/crypto/BaseCode.hx",128,0xa8a048f1)
HX_LOCAL_STACK_FRAME(_hx_pos_a75c3e49aaf71ae1_133_decode,"haxe.crypto.BaseCode","decode",0xc13b97b9,"haxe.crypto.BaseCode.decode","/opt/haxe/std/haxe/crypto/BaseCode.hx",133,0xa8a048f1)
namespace haxe{
namespace crypto{

void BaseCode_obj::__construct( ::haxe::io::Bytes base){
            	HX_STACKFRAME(&_hx_pos_a75c3e49aaf71ae1_33_new)
...
bool BaseCode_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes BaseCode_obj::encodeBytes( ::haxe::io::Bytes b){
            	HX_STACKFRAME(&_hx_pos_a75c3e49aaf71ae1_44_encodeBytes)
...
void BaseCode_obj::initTable(){
            	HX_STACKFRAME(&_hx_pos_a75c3e49aaf71ae1_72_initTable)
...
HX_DEFINE_DYNAMIC_FUNC0(BaseCode_obj,initTable,(void))
 ...
 ::haxe::io::Bytes BaseCode_obj::decodeBytes( ::haxe::io::Bytes b){
            	HX_STACKFRAME(&_hx_pos_a75c3e49aaf71ae1_81_decodeBytes)
...
::String BaseCode_obj::encodeString(::String s){
            	HX_STACKFRAME(&_hx_pos_a75c3e49aaf71ae1_116_encodeString)
...
::String BaseCode_obj::decodeString(::String s){
            	HX_STACKFRAME(&_hx_pos_a75c3e49aaf71ae1_124_decodeString)
...
::String BaseCode_obj::encode(::String s,::String base){
            	HX_GC_STACKFRAME(&_hx_pos_a75c3e49aaf71ae1_128_encode)
...
::String BaseCode_obj::decode(::String s,::String base){
            	HX_GC_STACKFRAME(&_hx_pos_a75c3e49aaf71ae1_133_decode)

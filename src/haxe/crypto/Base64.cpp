...
HX_LOCAL_STACK_FRAME(_hx_pos_5444b73bcc067879_35_encode,"haxe.crypto.Base64","encode",0xc6961450,"haxe.crypto.Base64.encode","/opt/haxe/std/haxe/crypto/Base64.hx",35,0x7cc0eba0)
HX_LOCAL_STACK_FRAME(_hx_pos_5444b73bcc067879_48_decode,"haxe.crypto.Base64","decode",0x319f7f68,"haxe.crypto.Base64.decode","/opt/haxe/std/haxe/crypto/Base64.hx",48,0x7cc0eba0)
HX_LOCAL_STACK_FRAME(_hx_pos_5444b73bcc067879_55_urlEncode,"haxe.crypto.Base64","urlEncode",0xe877cceb,"haxe.crypto.Base64.urlEncode","/opt/haxe/std/haxe/crypto/Base64.hx",55,0x7cc0eba0)
HX_LOCAL_STACK_FRAME(_hx_pos_5444b73bcc067879_68_urlDecode,"haxe.crypto.Base64","urlDecode",0x53813803,"haxe.crypto.Base64.urlDecode","/opt/haxe/std/haxe/crypto/Base64.hx",68,0x7cc0eba0)
HX_LOCAL_STACK_FRAME(_hx_pos_5444b73bcc067879_29_boot,"haxe.crypto.Base64","boot",0x49b2c3ec,"haxe.crypto.Base64.boot","/opt/haxe/std/haxe/crypto/Base64.hx",29,0x7cc0eba0)
HX_LOCAL_STACK_FRAME(_hx_pos_5444b73bcc067879_30_boot,"haxe.crypto.Base64","boot",0x49b2c3ec,"haxe.crypto.Base64.boot","/opt/haxe/std/haxe/crypto/Base64.hx",30,0x7cc0eba0)
HX_LOCAL_STACK_FRAME(_hx_pos_5444b73bcc067879_32_boot,"haxe.crypto.Base64","boot",0x49b2c3ec,"haxe.crypto.Base64.boot","/opt/haxe/std/haxe/crypto/Base64.hx",32,0x7cc0eba0)
HX_LOCAL_STACK_FRAME(_hx_pos_5444b73bcc067879_33_boot,"haxe.crypto.Base64","boot",0x49b2c3ec,"haxe.crypto.Base64.boot","/opt/haxe/std/haxe/crypto/Base64.hx",33,0x7cc0eba0)
namespace haxe{
namespace crypto{
...
::String Base64_obj::encode( ::haxe::io::Bytes bytes,::hx::Null< bool >  __o_complement){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_5444b73bcc067879_35_encode)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Base64_obj,encode,return )
 ...
 ::haxe::io::Bytes Base64_obj::decode(::String str,::hx::Null< bool >  __o_complement){
            		bool complement = __o_complement.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_5444b73bcc067879_48_decode)
...
::String Base64_obj::urlEncode( ::haxe::io::Bytes bytes,::hx::Null< bool >  __o_complement){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_5444b73bcc067879_55_urlEncode)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Base64_obj,urlEncode,return )
 ...
 ::haxe::io::Bytes Base64_obj::urlDecode(::String str,::hx::Null< bool >  __o_complement){
            		bool complement = __o_complement.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_5444b73bcc067879_68_urlDecode)

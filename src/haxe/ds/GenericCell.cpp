...
HX_DEFINE_STACK_FRAME(_hx_pos_8eb430629f655b4b_37_new,"haxe.ds.GenericCell","new",0x14fd4914,"haxe.ds.GenericCell.new","/opt/haxe/std/haxe/ds/GenericStack.hx",37,0xc2caf64c)
namespace haxe{
namespace ds{

void GenericCell_obj::__construct( ::Dynamic elt, ::haxe::ds::GenericCell next){
            	HX_STACKFRAME(&_hx_pos_8eb430629f655b4b_37_new)

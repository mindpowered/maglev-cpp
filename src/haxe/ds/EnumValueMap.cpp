...
HX_LOCAL_STACK_FRAME(_hx_pos_c615d1819af28349_32_compare,"haxe.ds.EnumValueMap","compare",0x806a7d1a,"haxe.ds.EnumValueMap.compare","/opt/haxe/std/haxe/ds/EnumValueMap.hx",32,0xbd4e9b11)
HX_LOCAL_STACK_FRAME(_hx_pos_c615d1819af28349_43_compareArgs,"haxe.ds.EnumValueMap","compareArgs",0x37a5cb97,"haxe.ds.EnumValueMap.compareArgs","/opt/haxe/std/haxe/ds/EnumValueMap.hx",43,0xbd4e9b11)
HX_LOCAL_STACK_FRAME(_hx_pos_c615d1819af28349_56_compareArg,"haxe.ds.EnumValueMap","compareArg",0xcee2e55c,"haxe.ds.EnumValueMap.compareArg","/opt/haxe/std/haxe/ds/EnumValueMap.hx",56,0xbd4e9b11)
HX_LOCAL_STACK_FRAME(_hx_pos_c615d1819af28349_65_copy,"haxe.ds.EnumValueMap","copy",0xa2232c20,"haxe.ds.EnumValueMap.copy","/opt/haxe/std/haxe/ds/EnumValueMap.hx",65,0xbd4e9b11)
namespace haxe{
namespace ds{

void EnumValueMap_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_c615d1819af28349_31_new)
...
int EnumValueMap_obj::compare( ::Dynamic _tmp_k1, ::Dynamic _tmp_k2){
            	HX_STACKFRAME(&_hx_pos_c615d1819af28349_32_compare)
...
int EnumValueMap_obj::compareArgs(::cpp::VirtualArray a1,::cpp::VirtualArray a2){
            	HX_STACKFRAME(&_hx_pos_c615d1819af28349_43_compareArgs)
...
int EnumValueMap_obj::compareArg( ::Dynamic v1, ::Dynamic v2){
            	HX_STACKFRAME(&_hx_pos_c615d1819af28349_56_compareArg)
...
HX_DEFINE_DYNAMIC_FUNC2(EnumValueMap_obj,compareArg,return )
 ...
 ::haxe::ds::BalancedTree EnumValueMap_obj::copy(){
            	HX_GC_STACKFRAME(&_hx_pos_c615d1819af28349_65_copy)

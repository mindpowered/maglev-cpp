...
HX_LOCAL_STACK_FRAME(_hx_pos_b4fb533f9915bd70_267_toString,"haxe.ds.TreeNode","toString",0xcf78dce3,"haxe.ds.TreeNode.toString","/opt/haxe/std/haxe/ds/BalancedTree.hx",267,0xe5e8edd7)
namespace haxe{
namespace ds{
...
void TreeNode_obj::__construct( ::haxe::ds::TreeNode l, ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode r,::hx::Null< int >  __o_h){
            	...
            	HX_STACKFRAME(&_hx_pos_b4fb533f9915bd70_252_new)
...
::String TreeNode_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_b4fb533f9915bd70_267_toString)

...
HX_LOCAL_STACK_FRAME(_hx_pos_3d5abd5159d5b620_36_unwrap,"haxe.ValueException","unwrap",0xe3875a0b,"haxe.ValueException.unwrap","/opt/haxe/std/haxe/ValueException.hx",36,0x48548d21)
namespace haxe{

void ValueException_obj::__construct( ::Dynamic value, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_3d5abd5159d5b620_23_new)
HXDLIN(  23)		{
...
bool ValueException_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic ValueException_obj::unwrap(){
            	HX_STACKFRAME(&_hx_pos_3d5abd5159d5b620_36_unwrap)

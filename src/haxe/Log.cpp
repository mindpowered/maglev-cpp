...
HX_LOCAL_STACK_FRAME(_hx_pos_4eaa2007a1569844_39_formatOutput,"haxe.Log","formatOutput",0x0271e52a,"haxe.Log.formatOutput","/opt/haxe/std/cpp/_std/haxe/Log.hx",39,0x3d12b7ae)
namespace haxe{
...
void _hx_run( ::Dynamic v, ::Dynamic infos){
            	HX_STACKFRAME(&_hx_pos_4eaa2007a1569844_30___default_trace)
...
::String Log_obj::formatOutput( ::Dynamic v, ::Dynamic infos){
            	HX_STACKFRAME(&_hx_pos_4eaa2007a1569844_39_formatOutput)
HXLINE(  40)		::String str = ::Std_obj::string(v);
HXLINE(  41)		if (::hx::IsNull( infos )) {
HXLINE(  42)			return str;
            		}
HXLINE(  43)		::String pstr = ( (::String)(((infos->__Field(HX_("fileName",e7,5a,43,62),::hx::paccDynamic) + HX_(":",3a,00,00,00)) + infos->__Field(HX_("lineNumber",dd,81,22,76),::hx::paccDynamic))) );
HXLINE(  44)		bool _hx_tmp;
HXDLIN(  44)		if (::hx::IsNotNull( infos )) {
HXLINE(  44)			_hx_tmp = ::hx::IsNotNull( infos->__Field(HX_("customParams",d7,51,18,ed),::hx::paccDynamic) );
            		}
            		else {
...
HXLINE(  45)				 ::Dynamic v = _g1->__get(_g);
HXDLIN(  45)				_g = (_g + 1);
HXLINE(  46)				str = (str + (HX_(", ",74,26,00,00) + ::Std_obj::string(v)));
            			}
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Log_obj,formatOutput,return )

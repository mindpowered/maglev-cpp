...
HX_LOCAL_STACK_FRAME(_hx_pos_afeb56f93b8e0a94_56_doParse,"haxe.format.JsonParser","doParse",0xa959e310,"haxe.format.JsonParser.doParse","/opt/haxe/std/haxe/format/JsonParser.hx",56,0x3577f7fe)
HX_LOCAL_STACK_FRAME(_hx_pos_afeb56f93b8e0a94_71_parseRec,"haxe.format.JsonParser","parseRec",0xda258b75,"haxe.format.JsonParser.parseRec","/opt/haxe/std/haxe/format/JsonParser.hx",71,0x3577f7fe)
HX_LOCAL_STACK_FRAME(_hx_pos_afeb56f93b8e0a94_152_parseString,"haxe.format.JsonParser","parseString",0x8c919bcc,"haxe.format.JsonParser.parseString","/opt/haxe/std/haxe/format/JsonParser.hx",152,0x3577f7fe)
HX_LOCAL_STACK_FRAME(_hx_pos_afeb56f93b8e0a94_256_parseNumber,"haxe.format.JsonParser","parseNumber",0x1cdbf9c4,"haxe.format.JsonParser.parseNumber","/opt/haxe/std/haxe/format/JsonParser.hx",256,0x3577f7fe)
HX_LOCAL_STACK_FRAME(_hx_pos_afeb56f93b8e0a94_309_nextChar,"haxe.format.JsonParser","nextChar",0xf138ae01,"haxe.format.JsonParser.nextChar","/opt/haxe/std/haxe/format/JsonParser.hx",309,0x3577f7fe)
HX_LOCAL_STACK_FRAME(_hx_pos_afeb56f93b8e0a94_312_invalidChar,"haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","/opt/haxe/std/haxe/format/JsonParser.hx",312,0x3577f7fe)
HX_LOCAL_STACK_FRAME(_hx_pos_afeb56f93b8e0a94_318_invalidNumber,"haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","/opt/haxe/std/haxe/format/JsonParser.hx",318,0x3577f7fe)
HX_LOCAL_STACK_FRAME(_hx_pos_afeb56f93b8e0a94_45_parse,"haxe.format.JsonParser","parse",0xed2c189b,"haxe.format.JsonParser.parse","/opt/haxe/std/haxe/format/JsonParser.hx",45,0x3577f7fe)
namespace haxe{
namespace format{

void JsonParser_obj::__construct(::String str){
            	HX_STACKFRAME(&_hx_pos_afeb56f93b8e0a94_51_new)
...
bool JsonParser_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JsonParser_obj::doParse(){
            	HX_STACKFRAME(&_hx_pos_afeb56f93b8e0a94_56_doParse)
...
HX_DEFINE_DYNAMIC_FUNC0(JsonParser_obj,doParse,return )
 ...
 ::Dynamic JsonParser_obj::parseRec(){
            	HX_STACKFRAME(&_hx_pos_afeb56f93b8e0a94_71_parseRec)
...
::String JsonParser_obj::parseString(){
            	HX_GC_STACKFRAME(&_hx_pos_afeb56f93b8e0a94_152_parseString)
...
HX_DEFINE_DYNAMIC_FUNC0(JsonParser_obj,parseString,return )
 ...
 ::Dynamic JsonParser_obj::parseNumber(int c){
            	HX_STACKFRAME(&_hx_pos_afeb56f93b8e0a94_256_parseNumber)
...
HXLINE( 304)		int i = ::Std_obj::_hx_int(f);
HXLINE( 305)		if ((i == f)) {
HXLINE( 305)			return i;
            		}
            		else {
...
int JsonParser_obj::nextChar(){
            	HX_STACKFRAME(&_hx_pos_afeb56f93b8e0a94_309_nextChar)
HXDLIN( 309)		return this->str.cca(this->pos++);
            	}
...
void JsonParser_obj::invalidChar(){
            	HX_STACKFRAME(&_hx_pos_afeb56f93b8e0a94_312_invalidChar)
HXLINE( 313)		this->pos--;
...
void JsonParser_obj::invalidNumber(int start){
            	HX_STACKFRAME(&_hx_pos_afeb56f93b8e0a94_318_invalidNumber)
...
HX_DEFINE_DYNAMIC_FUNC1(JsonParser_obj,invalidNumber,(void))
 ...
 ::Dynamic JsonParser_obj::parse(::String str){
            	HX_GC_STACKFRAME(&_hx_pos_afeb56f93b8e0a94_45_parse)

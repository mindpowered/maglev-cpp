...
HX_LOCAL_STACK_FRAME(_hx_pos_398d021480996d3e_72_ipad,"haxe.format.JsonPrinter","ipad",0x0d13fcd5,"haxe.format.JsonPrinter.ipad","/opt/haxe/std/haxe/format/JsonPrinter.hx",72,0x72c2fb85)
HX_LOCAL_STACK_FRAME(_hx_pos_398d021480996d3e_77_newl,"haxe.format.JsonPrinter","newl",0x1059c857,"haxe.format.JsonPrinter.newl","/opt/haxe/std/haxe/format/JsonPrinter.hx",77,0x72c2fb85)
HX_LOCAL_STACK_FRAME(_hx_pos_398d021480996d3e_81_write,"haxe.format.JsonPrinter","write",0x755dea34,"haxe.format.JsonPrinter.write","/opt/haxe/std/haxe/format/JsonPrinter.hx",81,0x72c2fb85)
...
HX_LOCAL_STACK_FRAME(_hx_pos_398d021480996d3e_158_classString,"haxe.format.JsonPrinter","classString",0x9219ba3e,"haxe.format.JsonPrinter.classString","/opt/haxe/std/haxe/format/JsonPrinter.hx",158,0x72c2fb85)
HX_LOCAL_STACK_FRAME(_hx_pos_398d021480996d3e_162_objString,"haxe.format.JsonPrinter","objString",0x583a4bfd,"haxe.format.JsonPrinter.objString","/opt/haxe/std/haxe/format/JsonPrinter.hx",162,0x72c2fb85)
HX_LOCAL_STACK_FRAME(_hx_pos_398d021480996d3e_165_fieldsString,"haxe.format.JsonPrinter","fieldsString",0x974bd375,"haxe.format.JsonPrinter.fieldsString","/opt/haxe/std/haxe/format/JsonPrinter.hx",165,0x72c2fb85)
HX_LOCAL_STACK_FRAME(_hx_pos_398d021480996d3e_196_quote,"haxe.format.JsonPrinter","quote",0x02f6a091,"haxe.format.JsonPrinter.quote","/opt/haxe/std/haxe/format/JsonPrinter.hx",196,0x72c2fb85)
...
HX_LOCAL_STACK_FRAME(_hx_pos_398d021480996d3e_44_print,"haxe.format.JsonPrinter","print",0x6d8fd582,"haxe.format.JsonPrinter.print","/opt/haxe/std/haxe/format/JsonPrinter.hx",44,0x72c2fb85)
namespace haxe{
namespace format{

void JsonPrinter_obj::__construct( ::Dynamic replacer,::String space){
            	HX_GC_STACKFRAME(&_hx_pos_398d021480996d3e_56_new)
...
void JsonPrinter_obj::ipad(){
            	HX_STACKFRAME(&_hx_pos_398d021480996d3e_72_ipad)
HXDLIN(  72)		if (this->pretty) {
HXLINE(  73)			::String v = ::StringTools_obj::lpad(HX_("",00,00,00,00),this->indent,(this->nind * this->indent.length));
HXDLIN(  73)			{
HXLINE(  73)				 ::StringBuf _this = this->buf;
HXDLIN(  73)				if (::hx::IsNotNull( _this->charBuf )) {
HXLINE(  73)					_this->flush();
            				}
HXDLIN(  73)				if (::hx::IsNull( _this->b )) {
HXLINE(  73)					_this->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v));
            				}
            				else {
HXLINE(  73)					::Array< ::String > _this1 = _this->b;
HXDLIN(  73)					_this1->push(::Std_obj::string(v));
            				}
            			}
            		}
            	}
...
void JsonPrinter_obj::newl(){
            	HX_STACKFRAME(&_hx_pos_398d021480996d3e_77_newl)
HXDLIN(  77)		if (this->pretty) {
HXLINE(  78)			 ::StringBuf _this = this->buf;
HXDLIN(  78)			{
HXLINE(  78)				if (::hx::IsNull( _this->charBuf )) {
HXLINE(  78)					_this->charBuf = ::Array_obj< char >::__new();
            				}
HXDLIN(  78)				_this->charBuf->push(10);
            			}
            		}
            	}
...
void JsonPrinter_obj::write( ::Dynamic k, ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_398d021480996d3e_81_write)
...
HXLINE( 136)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_6,1);
            					}
            					else {
...
HXLINE(  94)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_7,1);
            					}
            					else {
...
HXLINE(  86)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_8,1);
            					}
            					else {
...
void JsonPrinter_obj::classString( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_398d021480996d3e_158_classString)
...
void JsonPrinter_obj::objString( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_398d021480996d3e_162_objString)
HXDLIN( 162)		this->fieldsString(v,::Reflect_obj::fields(v));
            	}
...
void JsonPrinter_obj::fieldsString( ::Dynamic v,::Array< ::String > fields){
            	HX_STACKFRAME(&_hx_pos_398d021480996d3e_165_fieldsString)
HXLINE( 166)		{
...
void JsonPrinter_obj::quote(::String s){
            	HX_STACKFRAME(&_hx_pos_398d021480996d3e_196_quote)
HXLINE( 203)		{
...
HXLINE( 224)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_15,1);
            					}
            					else {
...
HXLINE( 222)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_16,1);
            					}
            					else {
...
HXLINE( 218)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_17,1);
            					}
            					else {
...
HXLINE( 226)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_18,1);
            					}
            					else {
...
HXLINE( 220)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_19,1);
            					}
            					else {
...
HXLINE( 214)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_20,1);
            					}
            					else {
...
HXLINE( 216)						_this->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_21,1);
            					}
            					else {
...
::String JsonPrinter_obj::print( ::Dynamic o, ::Dynamic replacer,::String space){
            	HX_GC_STACKFRAME(&_hx_pos_398d021480996d3e_44_print)

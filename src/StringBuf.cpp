...
HX_LOCAL_STACK_FRAME(_hx_pos_a06fb0f8fa8d00d6_37_charBufAsString,"StringBuf","charBufAsString",0x54d38cd4,"StringBuf.charBufAsString","/opt/haxe/std/cpp/_std/StringBuf.hx",37,0xd5b52e11)
HX_LOCAL_STACK_FRAME(_hx_pos_a06fb0f8fa8d00d6_43_flush,"StringBuf","flush",0xc7c14418,"StringBuf.flush","/opt/haxe/std/cpp/_std/StringBuf.hx",43,0xd5b52e11)
HX_LOCAL_STACK_FRAME(_hx_pos_a06fb0f8fa8d00d6_51_get_length,"StringBuf","get_length",0xe673d2db,"StringBuf.get_length","/opt/haxe/std/cpp/_std/StringBuf.hx",51,0xd5b52e11)
HX_LOCAL_STACK_FRAME(_hx_pos_a06fb0f8fa8d00d6_61_add,"StringBuf","add",0xaa9f1675,"StringBuf.add","/opt/haxe/std/cpp/_std/StringBuf.hx",61,0xd5b52e11)
HX_LOCAL_STACK_FRAME(_hx_pos_a06fb0f8fa8d00d6_70_addSub,"StringBuf","addSub",0x5b08020b,"StringBuf.addSub","/opt/haxe/std/cpp/_std/StringBuf.hx",70,0xd5b52e11)
HX_LOCAL_STACK_FRAME(_hx_pos_a06fb0f8fa8d00d6_81_addChar,"StringBuf","addChar",0x415c7feb,"StringBuf.addChar","/opt/haxe/std/cpp/_std/StringBuf.hx",81,0xd5b52e11)
HX_LOCAL_STACK_FRAME(_hx_pos_a06fb0f8fa8d00d6_92_toString,"StringBuf","toString",0x68f17bd8,"StringBuf.toString","/opt/haxe/std/cpp/_std/StringBuf.hx",92,0xd5b52e11)

void StringBuf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_a06fb0f8fa8d00d6_35_new)
            	}
...
::String StringBuf_obj::charBufAsString(){
            	HX_STACKFRAME(&_hx_pos_a06fb0f8fa8d00d6_37_charBufAsString)
...
void StringBuf_obj::flush(){
            	HX_STACKFRAME(&_hx_pos_a06fb0f8fa8d00d6_43_flush)
...
int StringBuf_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_a06fb0f8fa8d00d6_51_get_length)
HXLINE(  52)		int len = 0;
...
void StringBuf_obj::add( ::Dynamic x){
            	HX_STACKFRAME(&_hx_pos_a06fb0f8fa8d00d6_61_add)
...
void StringBuf_obj::addSub(::String s,int pos, ::Dynamic len){
            	HX_STACKFRAME(&_hx_pos_a06fb0f8fa8d00d6_70_addSub)
...
void StringBuf_obj::addChar(int c){
            	HX_STACKFRAME(&_hx_pos_a06fb0f8fa8d00d6_81_addChar)
HXDLIN(  81)		if ((c >= 127)) {
...
::String StringBuf_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a06fb0f8fa8d00d6_92_toString)

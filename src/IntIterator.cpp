...
HX_LOCAL_STACK_FRAME(_hx_pos_82079e8cd5980096_54_hasNext,"IntIterator","hasNext",0xd8737ddc,"IntIterator.hasNext","/opt/haxe/std/IntIterator.hx",54,0xacd87ccb)
HX_LOCAL_STACK_FRAME(_hx_pos_82079e8cd5980096_63_next,"IntIterator","next",0x6932a124,"IntIterator.next","/opt/haxe/std/IntIterator.hx",63,0xacd87ccb)

void IntIterator_obj::__construct(int min,int max){
            	HX_STACKFRAME(&_hx_pos_82079e8cd5980096_45_new)
...
bool IntIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_82079e8cd5980096_54_hasNext)
...
int IntIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_82079e8cd5980096_63_next)

...
HX_DEFINE_STACK_FRAME(_hx_pos_d207dc21e1bba0ef_508_new,"maglev.MagLevNumber","new",0xcbac55c9,"maglev.MagLevNumber.new","maglev/MagLev.hx",508,0x5b19476f)
HX_LOCAL_STACK_FRAME(_hx_pos_d207dc21e1bba0ef_513_getFloat,"maglev.MagLevNumber","getFloat",0xea8c131d,"maglev.MagLevNumber.getFloat","maglev/MagLev.hx",513,0x5b19476f)
HX_LOCAL_STACK_FRAME(_hx_pos_d207dc21e1bba0ef_516_getInt,"maglev.MagLevNumber","getInt",0xad8f4830,"maglev.MagLevNumber.getInt","maglev/MagLev.hx",516,0x5b19476f)
HX_LOCAL_STACK_FRAME(_hx_pos_d207dc21e1bba0ef_519_getType,"maglev.MagLevNumber","getType",0x371d9059,"maglev.MagLevNumber.getType","maglev/MagLev.hx",519,0x5b19476f)
HX_LOCAL_STACK_FRAME(_hx_pos_d207dc21e1bba0ef_525_isEqual,"maglev.MagLevNumber","isEqual",0x269a6153,"maglev.MagLevNumber.isEqual","maglev/MagLev.hx",525,0x5b19476f)
HX_LOCAL_STACK_FRAME(_hx_pos_d207dc21e1bba0ef_534_toJson,"maglev.MagLevNumber","toJson",0x8691af7a,"maglev.MagLevNumber.toJson","maglev/MagLev.hx",534,0x5b19476f)
HX_LOCAL_STACK_FRAME(_hx_pos_d207dc21e1bba0ef_503_fromFloat,"maglev.MagLevNumber","fromFloat",0x4977a9fb,"maglev.MagLevNumber.fromFloat","maglev/MagLev.hx",503,0x5b19476f)
HX_LOCAL_STACK_FRAME(_hx_pos_d207dc21e1bba0ef_506_fromInt,"maglev.MagLevNumber","fromInt",0x6f8ccb8e,"maglev.MagLevNumber.fromInt","maglev/MagLev.hx",506,0x5b19476f)
HX_LOCAL_STACK_FRAME(_hx_pos_d207dc21e1bba0ef_522_getStaticType,"maglev.MagLevNumber","getStaticType",0xdd720967,"maglev.MagLevNumber.getStaticType","maglev/MagLev.hx",522,0x5b19476f)
namespace maglev{

void MagLevNumber_obj::__construct(Float value){
            	HX_STACKFRAME(&_hx_pos_d207dc21e1bba0ef_508_new)
HXLINE( 509)		this->value = value;
...
Float MagLevNumber_obj::getFloat(){
            	HX_STACKFRAME(&_hx_pos_d207dc21e1bba0ef_513_getFloat)
HXDLIN( 513)		return this->value;
            	}
...
int MagLevNumber_obj::getInt(){
            	HX_STACKFRAME(&_hx_pos_d207dc21e1bba0ef_516_getInt)
HXDLIN( 516)		return ::Std_obj::_hx_int(this->value);
            	}
...
int MagLevNumber_obj::getType(){
            	HX_STACKFRAME(&_hx_pos_d207dc21e1bba0ef_519_getType)
HXDLIN( 519)		return 4;
            	}


bool MagLevNumber_obj::isEqual( ::maglev::MagLevAny other){
            	HX_STACKFRAME(&_hx_pos_d207dc21e1bba0ef_525_isEqual)
HXDLIN( 525)		int _hx_tmp = other->getType();
HXDLIN( 525)		if ((_hx_tmp == this->getType())) {
HXLINE( 526)			 ::maglev::MagLevNumber o = ::hx::TCast<  ::maglev::MagLevNumber >::cast(other);
HXLINE( 527)			Float _hx_tmp = this->getFloat();
HXDLIN( 527)			return (_hx_tmp == o->getFloat());
            		}
            		else {
...
HXLINE( 525)		return false;
 ...
 ::maglev::MagLevString MagLevNumber_obj::toJson(){
            	HX_GC_STACKFRAME(&_hx_pos_d207dc21e1bba0ef_534_toJson)
HXDLIN( 534)		return  ::maglev::MagLevString_obj::__alloc( HX_CTX ,::Std_obj::string(this->value));
            	}


 ::maglev::MagLevNumber MagLevNumber_obj::fromFloat(Float value){
            	HX_GC_STACKFRAME(&_hx_pos_d207dc21e1bba0ef_503_fromFloat)
HXDLIN( 503)		return  ::maglev::MagLevNumber_obj::__alloc( HX_CTX ,value);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(MagLevNumber_obj,fromFloat,return )
 ...
 ::maglev::MagLevNumber MagLevNumber_obj::fromInt(int value){
            	HX_GC_STACKFRAME(&_hx_pos_d207dc21e1bba0ef_506_fromInt)
HXDLIN( 506)		return  ::maglev::MagLevNumber_obj::__alloc( HX_CTX ,( (Float)(value) ));
            	}
...
int MagLevNumber_obj::getStaticType(){
            	HX_STACKFRAME(&_hx_pos_d207dc21e1bba0ef_522_getStaticType)
HXDLIN( 522)		return 4;
            	}

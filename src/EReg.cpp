...
HX_LOCAL_STACK_FRAME(_hx_pos_7950e67680857c11_36_match,"EReg","match",0x18fda1a6,"EReg.match","/opt/haxe/std/cpp/_std/EReg.hx",36,0x78a10b5a)
HX_LOCAL_STACK_FRAME(_hx_pos_7950e67680857c11_45_matched,"EReg","matched",0x8ce62f85,"EReg.matched","/opt/haxe/std/cpp/_std/EReg.hx",45,0x78a10b5a)
HX_LOCAL_STACK_FRAME(_hx_pos_7950e67680857c11_50_matchedLeft,"EReg","matchedLeft",0x93fe0a2c,"EReg.matchedLeft","/opt/haxe/std/cpp/_std/EReg.hx",50,0x78a10b5a)
HX_LOCAL_STACK_FRAME(_hx_pos_7950e67680857c11_55_matchedRight,"EReg","matchedRight",0x6157ea17,"EReg.matchedRight","/opt/haxe/std/cpp/_std/EReg.hx",55,0x78a10b5a)
HX_LOCAL_STACK_FRAME(_hx_pos_7950e67680857c11_62_matchedPos,"EReg","matchedPos",0x7007a70f,"EReg.matchedPos","/opt/haxe/std/cpp/_std/EReg.hx",62,0x78a10b5a)
HX_LOCAL_STACK_FRAME(_hx_pos_7950e67680857c11_65_matchSub,"EReg","matchSub",0xbc75cb7a,"EReg.matchSub","/opt/haxe/std/cpp/_std/EReg.hx",65,0x78a10b5a)
HX_LOCAL_STACK_FRAME(_hx_pos_7950e67680857c11_74_split,"EReg","split",0x9749433b,"EReg.split","/opt/haxe/std/cpp/_std/EReg.hx",74,0x78a10b5a)
HX_LOCAL_STACK_FRAME(_hx_pos_7950e67680857c11_98_replace,"EReg","replace",0xae923ad5,"EReg.replace","/opt/haxe/std/cpp/_std/EReg.hx",98,0x78a10b5a)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7950e67680857c11_149_map,"EReg","map",0x8b84d8bd,"EReg.map","/opt/haxe/std/cpp/_std/EReg.hx",149,0x78a10b5a)
HX_LOCAL_STACK_FRAME(_hx_pos_7950e67680857c11_180_toString,"EReg","toString",0x31b92aeb,"EReg.toString","/opt/haxe/std/cpp/_std/EReg.hx",180,0x78a10b5a)
HX_LOCAL_STACK_FRAME(_hx_pos_7950e67680857c11_174_escape,"EReg","escape",0xe40d4000,"EReg.escape","/opt/haxe/std/cpp/_std/EReg.hx",174,0x78a10b5a)
HX_LOCAL_STACK_FRAME(_hx_pos_7950e67680857c11_177_boot,"EReg","boot",0x817e12f1,"EReg.boot","/opt/haxe/std/cpp/_std/EReg.hx",177,0x78a10b5a)

void EReg_obj::__construct(::String r,::String opt){
            	HX_STACKFRAME(&_hx_pos_7950e67680857c11_28_new)
...
bool EReg_obj::match(::String s){
            	HX_STACKFRAME(&_hx_pos_7950e67680857c11_36_match)
...
::String EReg_obj::matched(int n){
            	HX_STACKFRAME(&_hx_pos_7950e67680857c11_45_matched)
...
::String EReg_obj::matchedLeft(){
            	HX_STACKFRAME(&_hx_pos_7950e67680857c11_50_matchedLeft)
...
::String EReg_obj::matchedRight(){
            	HX_STACKFRAME(&_hx_pos_7950e67680857c11_55_matchedRight)
...
HX_DEFINE_DYNAMIC_FUNC0(EReg_obj,matchedRight,return )
 ...
 ::Dynamic EReg_obj::matchedPos(){
            	HX_STACKFRAME(&_hx_pos_7950e67680857c11_62_matchedPos)
...
bool EReg_obj::matchSub(::String s,int pos,::hx::Null< int >  __o_len){
            	...
            	HX_STACKFRAME(&_hx_pos_7950e67680857c11_65_matchSub)
HXLINE(  66)		int p;
HXDLIN(  66)		if ((len < 0)) {
...
::Array< ::String > EReg_obj::split(::String s){
            	HX_STACKFRAME(&_hx_pos_7950e67680857c11_74_split)
HXLINE(  75)		int pos = 0;
...
::String EReg_obj::replace(::String s,::String by){
            	HX_GC_STACKFRAME(&_hx_pos_7950e67680857c11_98_replace)
...
::String EReg_obj::map(::String s, ::Dynamic f){
            	HX_GC_STACKFRAME(&_hx_pos_7950e67680857c11_149_map)
...
::String EReg_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_7950e67680857c11_180_toString)
...
::String EReg_obj::escape(::String s){
            		...
            		::String _hx_run( ::EReg r){
            			HX_STACKFRAME(&_hx_pos_7950e67680857c11_174_escape)
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_7950e67680857c11_177_boot)

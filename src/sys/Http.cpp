...
HX_DEFINE_STACK_FRAME(_hx_pos_6376fb7caa523fcb_48_new,"sys.Http","new",0xa5e0041b,"sys.Http.new","/opt/haxe/std/sys/Http.hx",48,0x836ba3ca)
HX_LOCAL_STACK_FRAME(_hx_pos_6376fb7caa523fcb_60_request,"sys.Http","request",0xbb950c8a,"sys.Http.request","/opt/haxe/std/sys/Http.hx",60,0x836ba3ca)
HX_LOCAL_STACK_FRAME(_hx_pos_6376fb7caa523fcb_56_request,"sys.Http","request",0xbb950c8a,"sys.Http.request","/opt/haxe/std/sys/Http.hx",56,0x836ba3ca)
static const bool _hx_array_data_00b75aa9_3[] = {
	0,
};
HX_LOCAL_STACK_FRAME(_hx_pos_6376fb7caa523fcb_77_fileTransfert,"sys.Http","fileTransfert",0xe32d4448,"sys.Http.fileTransfert","/opt/haxe/std/sys/Http.hx",77,0x836ba3ca)
HX_LOCAL_STACK_FRAME(_hx_pos_6376fb7caa523fcb_81_fileTransfer,"sys.Http","fileTransfer",0xaf8312ac,"sys.Http.fileTransfer","/opt/haxe/std/sys/Http.hx",81,0x836ba3ca)
HX_LOCAL_STACK_FRAME(_hx_pos_6376fb7caa523fcb_90_customRequest,"sys.Http","customRequest",0xecf59319,"sys.Http.customRequest","/opt/haxe/std/sys/Http.hx",90,0x836ba3ca)
...
static const ::String _hx_array_data_00b75aa9_22[] = {
	HX_("\"",22,00,00,00),
};
static const ::String _hx_array_data_00b75aa9_23[] = {
	HX_("\r\n",5d,0b,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_6376fb7caa523fcb_209_customRequest,"sys.Http","customRequest",0xecf59319,"sys.Http.customRequest","/opt/haxe/std/sys/Http.hx",209,0x836ba3ca)
HX_LOCAL_STACK_FRAME(_hx_pos_6376fb7caa523fcb_255_writeBody,"sys.Http","writeBody",0xc731a11c,"sys.Http.writeBody","/opt/haxe/std/sys/Http.hx",255,0x836ba3ca)
HX_LOCAL_STACK_FRAME(_hx_pos_6376fb7caa523fcb_280_readHttpResponse,"sys.Http","readHttpResponse",0xd67be204,"sys.Http.readHttpResponse","/opt/haxe/std/sys/Http.hx",280,0x836ba3ca)
HX_LOCAL_STACK_FRAME(_hx_pos_6376fb7caa523fcb_422_readChunk,"sys.Http","readChunk",0x940c4532,"sys.Http.readChunk","/opt/haxe/std/sys/Http.hx",422,0x836ba3ca)
HX_LOCAL_STACK_FRAME(_hx_pos_6376fb7caa523fcb_492_requestUrl,"sys.Http","requestUrl",0x3992c905,"sys.Http.requestUrl","/opt/haxe/std/sys/Http.hx",492,0x836ba3ca)
HX_LOCAL_STACK_FRAME(_hx_pos_6376fb7caa523fcb_495_requestUrl,"sys.Http","requestUrl",0x3992c905,"sys.Http.requestUrl","/opt/haxe/std/sys/Http.hx",495,0x836ba3ca)
HX_LOCAL_STACK_FRAME(_hx_pos_6376fb7caa523fcb_488_requestUrl,"sys.Http","requestUrl",0x3992c905,"sys.Http.requestUrl","/opt/haxe/std/sys/Http.hx",488,0x836ba3ca)
HX_LOCAL_STACK_FRAME(_hx_pos_6376fb7caa523fcb_46_boot,"sys.Http","boot",0x763c9417,"sys.Http.boot","/opt/haxe/std/sys/Http.hx",46,0x836ba3ca)
namespace sys{

void Http_obj::__construct(::String url){
            	HX_STACKFRAME(&_hx_pos_6376fb7caa523fcb_48_new)
...
void Http_obj::request( ::Dynamic post){
            		...
            		void _hx_run(::String e){
            			HX_GC_STACKFRAME(&_hx_pos_6376fb7caa523fcb_60_request)
...
HXLINE(  65)			_gthis->onError(e);
            	...
            	HX_GC_STACKFRAME(&_hx_pos_6376fb7caa523fcb_56_request)
...
void Http_obj::fileTransfert(::String argname,::String filename, ::haxe::io::Input file,int size,::String __o_mimeType){
            		::String mimeType = __o_mimeType;
            		if (::hx::IsNull(__o_mimeType)) mimeType = HX_("application/octet-stream",5d,f8,82,30);
            	HX_STACKFRAME(&_hx_pos_6376fb7caa523fcb_77_fileTransfert)
HXDLIN(  77)		this->fileTransfer(argname,filename,file,size,mimeType);
            	}
...
void Http_obj::fileTransfer(::String argname,::String filename, ::haxe::io::Input file,int size,::String __o_mimeType){
            		::String mimeType = __o_mimeType;
            		if (::hx::IsNull(__o_mimeType)) mimeType = HX_("application/octet-stream",5d,f8,82,30);
            	HX_STACKFRAME(&_hx_pos_6376fb7caa523fcb_81_fileTransfer)
HXDLIN(  81)		this->file =  ::Dynamic(::hx::Anon_obj::Create(5)
            			->setFixed(0,HX_("param",8d,80,55,bd),argname)
            			->setFixed(1,HX_("io",e6,5b,00,00),file)
            			->setFixed(2,HX_("size",c1,a0,53,4c),size)
            			->setFixed(3,HX_("mimeType",8e,56,09,5d),mimeType)
            			->setFixed(4,HX_("filename",c7,2e,6a,77),filename));
            	}
...
void Http_obj::customRequest(bool post, ::haxe::io::Output api, ::sys::net::Socket sock,::String method){
            	HX_GC_STACKFRAME(&_hx_pos_6376fb7caa523fcb_90_customRequest)
...
HXLINE( 143)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_11,1);
            						}
            						else {
...
HXLINE( 145)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_12,1);
            						}
            						else {
...
HXLINE( 146)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_13,1);
            						}
            						else {
...
HXLINE( 148)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_14,1);
            						}
            						else {
...
HXLINE( 149)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_15,1);
            						}
            						else {
...
HXLINE( 150)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_16,1);
            						}
            						else {
...
HXLINE( 152)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_17,1);
            						}
            						else {
...
HXLINE( 154)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_18,1);
            				}
            				else {
...
HXLINE( 156)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_19,1);
            				}
            				else {
...
HXLINE( 157)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_20,1);
            				}
            				else {
...
HXLINE( 159)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_21,1);
            				}
            				else {
...
HXLINE( 161)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_22,1);
            				}
            				else {
...
HXLINE( 162)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_23,1);
            				}
            				else {
...
HXDLIN( 209)				if (!(multipart)) {
            					...
            					bool _hx_run( ::Dynamic h){
            						HX_GC_STACKFRAME(&_hx_pos_6376fb7caa523fcb_209_customRequest)
...
void Http_obj::writeBody( ::haxe::io::BytesOutput body, ::haxe::io::Input fileInput,int fileSize,::String boundary, ::sys::net::Socket sock){
            	HX_STACKFRAME(&_hx_pos_6376fb7caa523fcb_255_writeBody)
...
void Http_obj::readHttpResponse( ::haxe::io::Output api, ::sys::net::Socket sock){
            	HX_GC_STACKFRAME(&_hx_pos_6376fb7caa523fcb_280_readHttpResponse)
...
bool Http_obj::readChunk( ::EReg chunk_re, ::haxe::io::Output api, ::haxe::io::Bytes buf,int len){
            	HX_GC_STACKFRAME(&_hx_pos_6376fb7caa523fcb_422_readChunk)
...
::String Http_obj::requestUrl(::String url){
            		...
            		void _hx_run(::String d){
            			HX_GC_STACKFRAME(&_hx_pos_6376fb7caa523fcb_492_requestUrl)
HXLINE( 492)			r[0] = d;
            		}
            		HX_END_LOCAL_FUNC1((void))
            		...
            		void _hx_run(::String e){
            			HX_GC_STACKFRAME(&_hx_pos_6376fb7caa523fcb_495_requestUrl)
HXLINE( 495)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_6376fb7caa523fcb_488_requestUrl)
HXLINE( 489)		 ::sys::Http h =  ::sys::Http_obj::__alloc( HX_CTX ,url);
HXLINE( 490)		::Array< ::String > r = ::Array_obj< ::String >::__new(1)->init(0,null());
HXLINE( 491)		h->onData =  ::Dynamic(new _hx_Closure_0(r));
HXLINE( 494)		h->onError =  ::Dynamic(new _hx_Closure_1());
HXLINE( 497)		h->request(false);
HXLINE( 498)		return r->__get(0);
            	}
...
::hx::Val Http_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"fileTransfer") ) { return ::hx::Val( fileTransfer_dyn() ); }
		break;
	case 13:
...
{
{
            	HX_STACKFRAME(&_hx_pos_6376fb7caa523fcb_46_boot)

...
HX_LOCAL_STACK_FRAME(_hx_pos_6b53d2beda877a20_31_exists,"sys.FileSystem","exists",0xf55bed9e,"sys.FileSystem.exists","/opt/haxe/std/cpp/_std/sys/FileSystem.hx",31,0xc3bbc03c)
HX_LOCAL_STACK_FRAME(_hx_pos_6b53d2beda877a20_35_rename,"sys.FileSystem","rename",0x3aa2fb40,"sys.FileSystem.rename","/opt/haxe/std/cpp/_std/sys/FileSystem.hx",35,0xc3bbc03c)
HX_LOCAL_STACK_FRAME(_hx_pos_6b53d2beda877a20_38_stat,"sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","/opt/haxe/std/cpp/_std/sys/FileSystem.hx",38,0xc3bbc03c)
HX_LOCAL_STACK_FRAME(_hx_pos_6b53d2beda877a20_61_fullPath,"sys.FileSystem","fullPath",0xc6463316,"sys.FileSystem.fullPath","/opt/haxe/std/cpp/_std/sys/FileSystem.hx",61,0xc3bbc03c)
HX_LOCAL_STACK_FRAME(_hx_pos_6b53d2beda877a20_64_absolutePath,"sys.FileSystem","absolutePath",0x5973f4fe,"sys.FileSystem.absolutePath","/opt/haxe/std/cpp/_std/sys/FileSystem.hx",64,0xc3bbc03c)
HX_LOCAL_STACK_FRAME(_hx_pos_6b53d2beda877a20_71_kind,"sys.FileSystem","kind",0xa0dedc96,"sys.FileSystem.kind","/opt/haxe/std/cpp/_std/sys/FileSystem.hx",71,0xc3bbc03c)
HX_LOCAL_STACK_FRAME(_hx_pos_6b53d2beda877a20_75_isDirectory,"sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","/opt/haxe/std/cpp/_std/sys/FileSystem.hx",75,0xc3bbc03c)
HX_LOCAL_STACK_FRAME(_hx_pos_6b53d2beda877a20_78_createDirectory,"sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","/opt/haxe/std/cpp/_std/sys/FileSystem.hx",78,0xc3bbc03c)
HX_LOCAL_STACK_FRAME(_hx_pos_6b53d2beda877a20_93_deleteFile,"sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","/opt/haxe/std/cpp/_std/sys/FileSystem.hx",93,0xc3bbc03c)
HX_LOCAL_STACK_FRAME(_hx_pos_6b53d2beda877a20_97_deleteDirectory,"sys.FileSystem","deleteDirectory",0x052a5cc0,"sys.FileSystem.deleteDirectory","/opt/haxe/std/cpp/_std/sys/FileSystem.hx",97,0xc3bbc03c)
HX_LOCAL_STACK_FRAME(_hx_pos_6b53d2beda877a20_101_readDirectory,"sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","/opt/haxe/std/cpp/_std/sys/FileSystem.hx",101,0xc3bbc03c)
HX_LOCAL_STACK_FRAME(_hx_pos_6b53d2beda877a20_105_makeCompatiblePath,"sys.FileSystem","makeCompatiblePath",0xee01a469,"sys.FileSystem.makeCompatiblePath","/opt/haxe/std/cpp/_std/sys/FileSystem.hx",105,0xc3bbc03c)
namespace sys{
...
bool FileSystem_obj::exists(::String path){
            	HX_STACKFRAME(&_hx_pos_6b53d2beda877a20_31_exists)
...
void FileSystem_obj::rename(::String path,::String newPath){
            	HX_STACKFRAME(&_hx_pos_6b53d2beda877a20_35_rename)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FileSystem_obj,rename,(void))
 ...
 ::Dynamic FileSystem_obj::stat(::String path){
            	HX_STACKFRAME(&_hx_pos_6b53d2beda877a20_38_stat)
HXLINE(  39)		::String s;
HXDLIN(  39)		bool s1;
...
::String FileSystem_obj::fullPath(::String relPath){
            	HX_STACKFRAME(&_hx_pos_6b53d2beda877a20_61_fullPath)
...
::String FileSystem_obj::absolutePath(::String relPath){
            	HX_STACKFRAME(&_hx_pos_6b53d2beda877a20_64_absolutePath)
...
::String FileSystem_obj::kind(::String path){
            	HX_STACKFRAME(&_hx_pos_6b53d2beda877a20_71_kind)
...
bool FileSystem_obj::isDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_6b53d2beda877a20_75_isDirectory)
...
void FileSystem_obj::createDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_6b53d2beda877a20_78_createDirectory)
...
void FileSystem_obj::deleteFile(::String path){
            	HX_STACKFRAME(&_hx_pos_6b53d2beda877a20_93_deleteFile)
...
void FileSystem_obj::deleteDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_6b53d2beda877a20_97_deleteDirectory)
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_6b53d2beda877a20_101_readDirectory)
...
::String FileSystem_obj::makeCompatiblePath(::String path){
            	HX_STACKFRAME(&_hx_pos_6b53d2beda877a20_105_makeCompatiblePath)

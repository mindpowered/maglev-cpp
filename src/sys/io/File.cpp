...
HX_LOCAL_STACK_FRAME(_hx_pos_7efad14c3d4314b3_30_getContent,"sys.io.File","getContent",0xb28b4a0e,"sys.io.File.getContent","/opt/haxe/std/cpp/_std/sys/io/File.hx",30,0x2a4fdc50)
HX_LOCAL_STACK_FRAME(_hx_pos_7efad14c3d4314b3_33_getBytes,"sys.io.File","getBytes",0xbe457600,"sys.io.File.getBytes","/opt/haxe/std/cpp/_std/sys/io/File.hx",33,0x2a4fdc50)
HX_LOCAL_STACK_FRAME(_hx_pos_7efad14c3d4314b3_38_saveContent,"sys.io.File","saveContent",0xa5557651,"sys.io.File.saveContent","/opt/haxe/std/cpp/_std/sys/io/File.hx",38,0x2a4fdc50)
HX_LOCAL_STACK_FRAME(_hx_pos_7efad14c3d4314b3_44_saveBytes,"sys.io.File","saveBytes",0x6700fb83,"sys.io.File.saveBytes","/opt/haxe/std/cpp/_std/sys/io/File.hx",44,0x2a4fdc50)
HX_LOCAL_STACK_FRAME(_hx_pos_7efad14c3d4314b3_51_read,"sys.io.File","read",0x203d07e1,"sys.io.File.read","/opt/haxe/std/cpp/_std/sys/io/File.hx",51,0x2a4fdc50)
HX_LOCAL_STACK_FRAME(_hx_pos_7efad14c3d4314b3_55_write,"sys.io.File","write",0xfec8a9f4,"sys.io.File.write","/opt/haxe/std/cpp/_std/sys/io/File.hx",55,0x2a4fdc50)
HX_LOCAL_STACK_FRAME(_hx_pos_7efad14c3d4314b3_59_append,"sys.io.File","append",0x02ba1725,"sys.io.File.append","/opt/haxe/std/cpp/_std/sys/io/File.hx",59,0x2a4fdc50)
HX_LOCAL_STACK_FRAME(_hx_pos_7efad14c3d4314b3_62_update,"sys.io.File","update",0xf9ebbb54,"sys.io.File.update","/opt/haxe/std/cpp/_std/sys/io/File.hx",62,0x2a4fdc50)
HX_LOCAL_STACK_FRAME(_hx_pos_7efad14c3d4314b3_69_copy,"sys.io.File","copy",0x165a7840,"sys.io.File.copy","/opt/haxe/std/cpp/_std/sys/io/File.hx",69,0x2a4fdc50)
namespace sys{
namespace io{
...
::String File_obj::getContent(::String path){
            	HX_STACKFRAME(&_hx_pos_7efad14c3d4314b3_30_getContent)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(File_obj,getContent,return )
 ...
 ::haxe::io::Bytes File_obj::getBytes(::String path){
            	HX_STACKFRAME(&_hx_pos_7efad14c3d4314b3_33_getBytes)
...
void File_obj::saveContent(::String path,::String content){
            	HX_STACKFRAME(&_hx_pos_7efad14c3d4314b3_38_saveContent)
...
void File_obj::saveBytes(::String path, ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_7efad14c3d4314b3_44_saveBytes)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,saveBytes,(void))
 ...
 ::sys::io::FileInput File_obj::read(::String path,::hx::Null< bool >  __o_binary){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_7efad14c3d4314b3_51_read)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,read,return )
 ...
 ::sys::io::FileOutput File_obj::write(::String path,::hx::Null< bool >  __o_binary){
            		bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_7efad14c3d4314b3_55_write)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,write,return )
 ...
 ::sys::io::FileOutput File_obj::append(::String path,::hx::Null< bool >  __o_binary){
            		bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_7efad14c3d4314b3_59_append)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,append,return )
 ...
 ::sys::io::FileOutput File_obj::update(::String path,::hx::Null< bool >  __o_binary){
            		bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_7efad14c3d4314b3_62_update)
...
void File_obj::copy(::String srcPath,::String dstPath){
            	HX_STACKFRAME(&_hx_pos_7efad14c3d4314b3_69_copy)

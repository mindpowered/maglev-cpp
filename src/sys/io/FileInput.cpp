...
HX_DEFINE_STACK_FRAME(_hx_pos_31713743344da5cf_33_new,"sys.io.FileInput","new",0x565591b9,"sys.io.FileInput.new","/opt/haxe/std/cpp/_std/sys/io/FileInput.hx",33,0x10e95242)
HX_LOCAL_STACK_FRAME(_hx_pos_31713743344da5cf_37_readByte,"sys.io.FileInput","readByte",0x25e0b585,"sys.io.FileInput.readByte","/opt/haxe/std/cpp/_std/sys/io/FileInput.hx",37,0x10e95242)
HX_LOCAL_STACK_FRAME(_hx_pos_31713743344da5cf_48_readBytes,"sys.io.FileInput","readBytes",0xfebe1f4e,"sys.io.FileInput.readBytes","/opt/haxe/std/cpp/_std/sys/io/FileInput.hx",48,0x10e95242)
HX_LOCAL_STACK_FRAME(_hx_pos_31713743344da5cf_58_close,"sys.io.FileInput","close",0x735aa151,"sys.io.FileInput.close","/opt/haxe/std/cpp/_std/sys/io/FileInput.hx",58,0x10e95242)
HX_LOCAL_STACK_FRAME(_hx_pos_31713743344da5cf_64_seek,"sys.io.FileInput","seek",0x37d7f1ff,"sys.io.FileInput.seek","/opt/haxe/std/cpp/_std/sys/io/FileInput.hx",64,0x10e95242)
HX_LOCAL_STACK_FRAME(_hx_pos_31713743344da5cf_68_tell,"sys.io.FileInput","tell",0x38812eb8,"sys.io.FileInput.tell","/opt/haxe/std/cpp/_std/sys/io/FileInput.hx",68,0x10e95242)
HX_LOCAL_STACK_FRAME(_hx_pos_31713743344da5cf_72_eof,"sys.io.FileInput","eof",0x564ec615,"sys.io.FileInput.eof","/opt/haxe/std/cpp/_std/sys/io/FileInput.hx",72,0x10e95242)
namespace sys{
namespace io{

void FileInput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_31713743344da5cf_33_new)
...
int FileInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_31713743344da5cf_37_readByte)
HXDLIN(  37)		try {
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_GC_STACKFRAME(&_hx_pos_31713743344da5cf_48_readBytes)
HXDLIN(  48)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void FileInput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_31713743344da5cf_58_close)
...
void FileInput_obj::seek(int p, ::sys::io::FileSeek pos){
            	HX_STACKFRAME(&_hx_pos_31713743344da5cf_64_seek)
...
int FileInput_obj::tell(){
            	HX_STACKFRAME(&_hx_pos_31713743344da5cf_68_tell)
...
bool FileInput_obj::eof(){
            	HX_STACKFRAME(&_hx_pos_31713743344da5cf_72_eof)

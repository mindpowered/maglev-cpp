...
HX_DEFINE_STACK_FRAME(_hx_pos_66712b3136f85d30_33_new,"sys.io.FileOutput","new",0x19e22a16,"sys.io.FileOutput.new","/opt/haxe/std/cpp/_std/sys/io/FileOutput.hx",33,0xa554bd4f)
HX_LOCAL_STACK_FRAME(_hx_pos_66712b3136f85d30_37_writeByte,"sys.io.FileOutput","writeByte",0x887099bd,"sys.io.FileOutput.writeByte","/opt/haxe/std/cpp/_std/sys/io/FileOutput.hx",37,0xa554bd4f)
HX_LOCAL_STACK_FRAME(_hx_pos_66712b3136f85d30_44_writeBytes,"sys.io.FileOutput","writeBytes",0xda15ec16,"sys.io.FileOutput.writeBytes","/opt/haxe/std/cpp/_std/sys/io/FileOutput.hx",44,0xa554bd4f)
HX_LOCAL_STACK_FRAME(_hx_pos_66712b3136f85d30_48_flush,"sys.io.FileOutput","flush",0x5fbc15fa,"sys.io.FileOutput.flush","/opt/haxe/std/cpp/_std/sys/io/FileOutput.hx",48,0xa554bd4f)
HX_LOCAL_STACK_FRAME(_hx_pos_66712b3136f85d30_51_close,"sys.io.FileOutput","close",0xa583caee,"sys.io.FileOutput.close","/opt/haxe/std/cpp/_std/sys/io/FileOutput.hx",51,0xa554bd4f)
HX_LOCAL_STACK_FRAME(_hx_pos_66712b3136f85d30_57_seek,"sys.io.FileOutput","seek",0x8f50ab02,"sys.io.FileOutput.seek","/opt/haxe/std/cpp/_std/sys/io/FileOutput.hx",57,0xa554bd4f)
HX_LOCAL_STACK_FRAME(_hx_pos_66712b3136f85d30_61_tell,"sys.io.FileOutput","tell",0x8ff9e7bb,"sys.io.FileOutput.tell","/opt/haxe/std/cpp/_std/sys/io/FileOutput.hx",61,0xa554bd4f)
namespace sys{
namespace io{

void FileOutput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_66712b3136f85d30_33_new)
...
void FileOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_66712b3136f85d30_37_writeByte)
HXDLIN(  37)		try {
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_STACKFRAME(&_hx_pos_66712b3136f85d30_44_writeBytes)
HXDLIN(  44)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void FileOutput_obj::flush(){
            	HX_STACKFRAME(&_hx_pos_66712b3136f85d30_48_flush)
HXDLIN(  48)		_hx_std_file_flush(this->_hx___f);
            	}


void FileOutput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_66712b3136f85d30_51_close)
...
void FileOutput_obj::seek(int p, ::sys::io::FileSeek pos){
            	HX_STACKFRAME(&_hx_pos_66712b3136f85d30_57_seek)
HXDLIN(  57)		int _hx_tmp;
HXDLIN(  57)		if (::hx::IsEq( pos,::sys::io::FileSeek_obj::SeekBegin_dyn() )) {
HXDLIN(  57)			_hx_tmp = 0;
            		}
            		else {
HXDLIN(  57)			if (::hx::IsEq( pos,::sys::io::FileSeek_obj::SeekCur_dyn() )) {
HXDLIN(  57)				_hx_tmp = 1;
            			}
            			else {
HXDLIN(  57)				_hx_tmp = 2;
...
int FileOutput_obj::tell(){
            	HX_STACKFRAME(&_hx_pos_66712b3136f85d30_61_tell)

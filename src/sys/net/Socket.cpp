...
HX_DEFINE_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_115_new,"sys.net.Socket","new",0x202a8cf7,"sys.net.Socket.new","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",115,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_133_init,"sys.net.Socket","init",0x01c98299,"sys.net.Socket.init","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",133,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_145_close,"sys.net.Socket","close",0x18d3680f,"sys.net.Socket.close","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",145,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_157_read,"sys.net.Socket","read",0x07b592df,"sys.net.Socket.read","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",157,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_166_write,"sys.net.Socket","write",0xa0c9bd36,"sys.net.Socket.write","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",166,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_170_connect,"sys.net.Socket","connect",0x1ee69001,"sys.net.Socket.connect","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",170,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_195_listen,"sys.net.Socket","listen",0x81cfc410,"sys.net.Socket.listen","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",195,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_199_shutdown,"sys.net.Socket","shutdown",0x9b2f3c9f,"sys.net.Socket.shutdown","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",199,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_203_bind,"sys.net.Socket","bind",0xfd253d46,"sys.net.Socket.bind","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",203,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_216_accept,"sys.net.Socket","accept",0x9cdc8ed1,"sys.net.Socket.accept","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",216,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_225_peer,"sys.net.Socket","peer",0x0663292b,"sys.net.Socket.peer","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",225,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_235_host,"sys.net.Socket","host",0x012116f1,"sys.net.Socket.host","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",235,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_245_setTimeout,"sys.net.Socket","setTimeout",0x1b505368,"sys.net.Socket.setTimeout","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",245,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_251_waitForRead,"sys.net.Socket","waitForRead",0x697cd8a1,"sys.net.Socket.waitForRead","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",251,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_254_setBlocking,"sys.net.Socket","setBlocking",0xe5689b0e,"sys.net.Socket.setBlocking","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",254,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_259_setFastSend,"sys.net.Socket","setFastSend",0x54236f5d,"sys.net.Socket.setFastSend","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",259,0xb02a14a2)
HX_LOCAL_STACK_FRAME(_hx_pos_c4ebc73bb9d81fa0_265_select,"sys.net.Socket","select",0xfc0916c5,"sys.net.Socket.select","/opt/haxe/std/cpp/_std/sys/net/Socket.hx",265,0xb02a14a2)
namespace sys{
namespace net{

void Socket_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_115_new)
...
void Socket_obj::init(){
            	HX_GC_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_133_init)
...
void Socket_obj::close(){
            	HX_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_145_close)
...
::String Socket_obj::read(){
            	HX_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_157_read)
...
void Socket_obj::write(::String content){
            	HX_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_166_write)
...
void Socket_obj::connect( ::sys::net::Host host,int port){
            	HX_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_170_connect)
HXDLIN( 170)		try {
...
void Socket_obj::listen(int connections){
            	HX_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_195_listen)
...
void Socket_obj::shutdown(bool read,bool write){
            	HX_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_199_shutdown)
...
void Socket_obj::bind( ::sys::net::Host host,int port){
            	HX_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_203_bind)
...
HX_DEFINE_DYNAMIC_FUNC2(Socket_obj,bind,(void))
 ...
 ::sys::net::Socket Socket_obj::accept(){
            	HX_GC_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_216_accept)
...
HX_DEFINE_DYNAMIC_FUNC0(Socket_obj,accept,return )
 ...
 ::Dynamic Socket_obj::peer(){
            	HX_GC_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_225_peer)
...
HX_DEFINE_DYNAMIC_FUNC0(Socket_obj,peer,return )
 ...
 ::Dynamic Socket_obj::host(){
            	HX_GC_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_235_host)
...
void Socket_obj::setTimeout(Float timeout){
            	HX_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_245_setTimeout)
...
void Socket_obj::waitForRead(){
            	HX_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_251_waitForRead)
...
void Socket_obj::setBlocking(bool b){
            	HX_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_254_setBlocking)
...
void Socket_obj::setFastSend(bool b){
            	HX_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_259_setFastSend)
...
HX_DEFINE_DYNAMIC_FUNC1(Socket_obj,setFastSend,(void))
 ...
 ::Dynamic Socket_obj::select(::Array< ::Dynamic> read,::Array< ::Dynamic> write,::Array< ::Dynamic> others, ::Dynamic timeout){
            	HX_STACKFRAME(&_hx_pos_c4ebc73bb9d81fa0_265_select)

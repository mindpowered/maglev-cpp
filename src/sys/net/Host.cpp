...
HX_DEFINE_STACK_FRAME(_hx_pos_fc08352a7fe3c510_35_new,"sys.net.Host","new",0x056496ac,"sys.net.Host.new","/opt/haxe/std/cpp/_std/sys/net/Host.hx",35,0xa90c244d)
HX_LOCAL_STACK_FRAME(_hx_pos_475f832c0ef6e0dc_57___init__,"::sys::net::Host_obj","__init__",0x01315e0e,"::sys::net::Host_obj.__init__","/opt/haxe/std/cpp/_std/sys/net/Host.hx",57,0xa90c244d)
HX_LOCAL_STACK_FRAME(_hx_pos_fc08352a7fe3c510_45_toString,"sys.net.Host","toString",0xe5efb6e0,"sys.net.Host.toString","/opt/haxe/std/cpp/_std/sys/net/Host.hx",45,0xa90c244d)
HX_LOCAL_STACK_FRAME(_hx_pos_fc08352a7fe3c510_49_reverse,"sys.net.Host","reverse",0x015c156e,"sys.net.Host.reverse","/opt/haxe/std/cpp/_std/sys/net/Host.hx",49,0xa90c244d)
HX_LOCAL_STACK_FRAME(_hx_pos_fc08352a7fe3c510_53_localhost,"sys.net.Host","localhost",0x3fc4b19f,"sys.net.Host.localhost","/opt/haxe/std/cpp/_std/sys/net/Host.hx",53,0xa90c244d)
namespace sys{
namespace net{

void Host_obj::__construct(::String name){
            	HX_STACKFRAME(&_hx_pos_fc08352a7fe3c510_35_new)
...
void Host_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_475f832c0ef6e0dc_57___init__)
HXDLIN(  57)		_hx_std_socket_init();
            	}


::String Host_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_fc08352a7fe3c510_45_toString)
...
::String Host_obj::reverse(){
            	HX_STACKFRAME(&_hx_pos_fc08352a7fe3c510_49_reverse)
HXDLIN(  49)		if (::hx::IsNull( this->ipv6 )) {
HXDLIN(  49)			return _hx_std_host_reverse(this->ip);
            		}
            		else {
HXDLIN(  49)			return _hx_std_host_reverse_ipv6(this->ipv6);
            		}
...
::String Host_obj::localhost(){
            	HX_STACKFRAME(&_hx_pos_fc08352a7fe3c510_53_localhost)
HXDLIN(  53)		return _hx_std_host_local();
            	}

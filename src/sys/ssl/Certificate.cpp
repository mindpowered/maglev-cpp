...
HX_DEFINE_STACK_FRAME(_hx_pos_3ee2a9492374b912_33_new,"sys.ssl.Certificate","new",0x5388a2e6,"sys.ssl.Certificate.new","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",33,0xdbebbc61)
HX_LOCAL_STACK_FRAME(_hx_pos_c1bf15419dfc85a0_134___init__,"::sys::ssl::Certificate_obj","__init__",0x6779d94e,"::sys::ssl::Certificate_obj.__init__","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",134,0xdbebbc61)
HX_LOCAL_STACK_FRAME(_hx_pos_3ee2a9492374b912_95_get_commonName,"sys.ssl.Certificate","get_commonName",0x8781dc99,"sys.ssl.Certificate.get_commonName","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",95,0xdbebbc61)
HX_LOCAL_STACK_FRAME(_hx_pos_3ee2a9492374b912_99_get_altNames,"sys.ssl.Certificate","get_altNames",0xdaf892a2,"sys.ssl.Certificate.get_altNames","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",99,0xdbebbc61)
HX_LOCAL_STACK_FRAME(_hx_pos_3ee2a9492374b912_103_subject,"sys.ssl.Certificate","subject",0x743f8f32,"sys.ssl.Certificate.subject","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",103,0xdbebbc61)
HX_LOCAL_STACK_FRAME(_hx_pos_3ee2a9492374b912_107_issuer,"sys.ssl.Certificate","issuer",0x4b9747b3,"sys.ssl.Certificate.issuer","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",107,0xdbebbc61)
HX_LOCAL_STACK_FRAME(_hx_pos_3ee2a9492374b912_110_get_notBefore,"sys.ssl.Certificate","get_notBefore",0x9d1a7bcf,"sys.ssl.Certificate.get_notBefore","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",110,0xdbebbc61)
HX_LOCAL_STACK_FRAME(_hx_pos_3ee2a9492374b912_115_get_notAfter,"sys.ssl.Certificate","get_notAfter",0xc66698cc,"sys.ssl.Certificate.get_notAfter","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",115,0xdbebbc61)
HX_LOCAL_STACK_FRAME(_hx_pos_3ee2a9492374b912_120_next,"sys.ssl.Certificate","next",0xc405e7ad,"sys.ssl.Certificate.next","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",120,0xdbebbc61)
HX_LOCAL_STACK_FRAME(_hx_pos_3ee2a9492374b912_126_add,"sys.ssl.Certificate","add",0x537ec4a7,"sys.ssl.Certificate.add","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",126,0xdbebbc61)
HX_LOCAL_STACK_FRAME(_hx_pos_3ee2a9492374b912_130_addDER,"sys.ssl.Certificate","addDER",0x6baa336a,"sys.ssl.Certificate.addDER","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",130,0xdbebbc61)
HX_LOCAL_STACK_FRAME(_hx_pos_3ee2a9492374b912_39_loadFile,"sys.ssl.Certificate","loadFile",0xca3fe77c,"sys.ssl.Certificate.loadFile","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",39,0xdbebbc61)
HX_LOCAL_STACK_FRAME(_hx_pos_3ee2a9492374b912_43_loadPath,"sys.ssl.Certificate","loadPath",0xd0d5fea5,"sys.ssl.Certificate.loadPath","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",43,0xdbebbc61)
HX_LOCAL_STACK_FRAME(_hx_pos_3ee2a9492374b912_47_fromString,"sys.ssl.Certificate","fromString",0xe1c55815,"sys.ssl.Certificate.fromString","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",47,0xdbebbc61)
HX_LOCAL_STACK_FRAME(_hx_pos_3ee2a9492374b912_50_loadDefaults,"sys.ssl.Certificate","loadDefaults",0xcc9e6992,"sys.ssl.Certificate.loadDefaults","/opt/haxe/std/cpp/_std/sys/ssl/Certificate.hx",50,0xdbebbc61)
...
void Certificate_obj::__construct( ::Dynamic x, ::sys::ssl::Certificate h){
            	HX_STACKFRAME(&_hx_pos_3ee2a9492374b912_33_new)
...
void Certificate_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_c1bf15419dfc85a0_134___init__)
HXDLIN( 134)		_hx_ssl_init();
            	}


::String Certificate_obj::get_commonName(){
            	HX_STACKFRAME(&_hx_pos_3ee2a9492374b912_95_get_commonName)
...
::Array< ::String > Certificate_obj::get_altNames(){
            	HX_STACKFRAME(&_hx_pos_3ee2a9492374b912_99_get_altNames)
...
::String Certificate_obj::subject(::String field){
            	HX_STACKFRAME(&_hx_pos_3ee2a9492374b912_103_subject)
...
::String Certificate_obj::issuer(::String field){
            	HX_STACKFRAME(&_hx_pos_3ee2a9492374b912_107_issuer)
...
HX_DEFINE_DYNAMIC_FUNC1(Certificate_obj,issuer,return )
 ...
 ::Date Certificate_obj::get_notBefore(){
            	HX_GC_STACKFRAME(&_hx_pos_3ee2a9492374b912_110_get_notBefore)
...
HX_DEFINE_DYNAMIC_FUNC0(Certificate_obj,get_notBefore,return )
 ...
 ::Date Certificate_obj::get_notAfter(){
            	HX_GC_STACKFRAME(&_hx_pos_3ee2a9492374b912_115_get_notAfter)
...
HX_DEFINE_DYNAMIC_FUNC0(Certificate_obj,get_notAfter,return )
 ...
 ::sys::ssl::Certificate Certificate_obj::next(){
            	HX_GC_STACKFRAME(&_hx_pos_3ee2a9492374b912_120_next)
...
void Certificate_obj::add(::String pem){
            	HX_STACKFRAME(&_hx_pos_3ee2a9492374b912_126_add)
...
void Certificate_obj::addDER( ::haxe::io::Bytes der){
            	HX_STACKFRAME(&_hx_pos_3ee2a9492374b912_130_addDER)
...
HX_DEFINE_DYNAMIC_FUNC1(Certificate_obj,addDER,(void))
 ...
 ::sys::ssl::Certificate Certificate_obj::loadFile(::String file){
            	HX_GC_STACKFRAME(&_hx_pos_3ee2a9492374b912_39_loadFile)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Certificate_obj,loadFile,return )
 ...
 ::sys::ssl::Certificate Certificate_obj::loadPath(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_3ee2a9492374b912_43_loadPath)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Certificate_obj,loadPath,return )
 ...
 ::sys::ssl::Certificate Certificate_obj::fromString(::String str){
            	HX_GC_STACKFRAME(&_hx_pos_3ee2a9492374b912_47_fromString)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Certificate_obj,fromString,return )
 ...
 ::sys::ssl::Certificate Certificate_obj::loadDefaults(){
            	HX_GC_STACKFRAME(&_hx_pos_3ee2a9492374b912_50_loadDefaults)

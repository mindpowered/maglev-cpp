...
HX_DEFINE_STACK_FRAME(_hx_pos_c477f2573050589f_82_new,"sys.ssl._Socket.SocketOutput","new",0xc0bfe785,"sys.ssl._Socket.SocketOutput.new","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",82,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_c477f2573050589f_85_writeByte,"sys.ssl._Socket.SocketOutput","writeByte",0x9388946c,"sys.ssl._Socket.SocketOutput.writeByte","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",85,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_c477f2573050589f_100_writeBytes,"sys.ssl._Socket.SocketOutput","writeBytes",0x83f94a87,"sys.ssl._Socket.SocketOutput.writeBytes","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",100,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_c477f2573050589f_111_close,"sys.ssl._Socket.SocketOutput","close",0x0d5f021d,"sys.ssl._Socket.SocketOutput.close","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",111,0x9e712cd1)
namespace sys{
namespace ssl{
namespace _Socket{

void SocketOutput_obj::__construct( ::sys::ssl::Socket s){
            	HX_STACKFRAME(&_hx_pos_c477f2573050589f_82_new)
...
void SocketOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_c477f2573050589f_85_writeByte)
...
int SocketOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_c477f2573050589f_100_writeBytes)
HXDLIN( 100)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void SocketOutput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_c477f2573050589f_111_close)

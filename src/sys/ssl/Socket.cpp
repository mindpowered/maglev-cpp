...
HX_DEFINE_STACK_FRAME(_hx_pos_2fd50dee672df425_119_new,"sys.ssl.Socket","new",0xb0189de8,"sys.ssl.Socket.new","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",119,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_a80685499b54432a_295___init__,"::sys::ssl::Socket_obj","__init__",0xb5703314,"::sys::ssl::Socket_obj.__init__","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",295,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_138_init,"sys.ssl.Socket","init",0x622a4488,"sys.ssl.Socket.init","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",138,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_152_connect,"sys.ssl.Socket","connect",0x6aae6d72,"sys.ssl.Socket.connect","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",152,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_174_handshake,"sys.ssl.Socket","handshake",0x5679847f,"sys.ssl.Socket.handshake","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",174,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_188_setCA,"sys.ssl.Socket","setCA",0x3ee8c248,"sys.ssl.Socket.setCA","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",188,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_192_setHostname,"sys.ssl.Socket","setHostname",0xf84c74fd,"sys.ssl.Socket.setHostname","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",192,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_195_setCertificate,"sys.ssl.Socket","setCertificate",0x9a37940d,"sys.ssl.Socket.setCertificate","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",195,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_200_read,"sys.ssl.Socket","read",0x681654ce,"sys.ssl.Socket.read","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",200,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_208_write,"sys.ssl.Socket","write",0x9512ac67,"sys.ssl.Socket.write","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",208,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_213_close,"sys.ssl.Socket","close",0x0d1c5740,"sys.ssl.Socket.close","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",213,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_228_addSNICertificate,"sys.ssl.Socket","addSNICertificate",0xa0bf5dd2,"sys.ssl.Socket.addSNICertificate","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",228,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_234_bind,"sys.ssl.Socket","bind",0x5d85ff35,"sys.ssl.Socket.bind","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",234,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_240_accept,"sys.ssl.Socket","accept",0x6864ea80,"sys.ssl.Socket.accept","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",240,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_255_peerCertificate,"sys.ssl.Socket","peerCertificate",0x40a4781d,"sys.ssl.Socket.peerCertificate","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",255,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_260_buildSSLConfig,"sys.ssl.Socket","buildSSLConfig",0xf55ff618,"sys.ssl.Socket.buildSSLConfig","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",260,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_267_buildSSLConfig,"sys.ssl.Socket","buildSSLConfig",0xf55ff618,"sys.ssl.Socket.buildSSLConfig","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",267,0x9e712cd1)
HX_LOCAL_STACK_FRAME(_hx_pos_2fd50dee672df425_120_boot,"sys.ssl.Socket","boot",0x5d8a8daa,"sys.ssl.Socket.boot","/opt/haxe/std/cpp/_std/sys/ssl/Socket.hx",120,0x9e712cd1)
namespace sys{
namespace ssl{

void Socket_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_2fd50dee672df425_119_new)
...
void Socket_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_a80685499b54432a_295___init__)
HXDLIN( 295)		_hx_ssl_init();
            	}


void Socket_obj::init(){
            	HX_GC_STACKFRAME(&_hx_pos_2fd50dee672df425_138_init)
...
void Socket_obj::connect( ::sys::net::Host host,int port){
            	HX_STACKFRAME(&_hx_pos_2fd50dee672df425_152_connect)
HXDLIN( 152)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void Socket_obj::handshake(){
            	HX_STACKFRAME(&_hx_pos_2fd50dee672df425_174_handshake)
...
void Socket_obj::setCA( ::sys::ssl::Certificate cert){
            	HX_STACKFRAME(&_hx_pos_2fd50dee672df425_188_setCA)
...
void Socket_obj::setHostname(::String name){
            	HX_STACKFRAME(&_hx_pos_2fd50dee672df425_192_setHostname)
...
void Socket_obj::setCertificate( ::sys::ssl::Certificate cert, ::sys::ssl::Key key){
            	HX_STACKFRAME(&_hx_pos_2fd50dee672df425_195_setCertificate)
...
::String Socket_obj::read(){
            	HX_STACKFRAME(&_hx_pos_2fd50dee672df425_200_read)
...
void Socket_obj::write(::String content){
            	HX_STACKFRAME(&_hx_pos_2fd50dee672df425_208_write)
...
void Socket_obj::close(){
            	HX_STACKFRAME(&_hx_pos_2fd50dee672df425_213_close)
...
void Socket_obj::addSNICertificate( ::Dynamic cbServernameMatch, ::sys::ssl::Certificate cert, ::sys::ssl::Key key){
            	HX_STACKFRAME(&_hx_pos_2fd50dee672df425_228_addSNICertificate)
...
void Socket_obj::bind( ::sys::net::Host host,int port){
            	HX_STACKFRAME(&_hx_pos_2fd50dee672df425_234_bind)
...
HXLINE( 237)		_hx_std_socket_bind(this->__s,host->ip,port);
 ...
 ::sys::net::Socket Socket_obj::accept(){
            	HX_GC_STACKFRAME(&_hx_pos_2fd50dee672df425_240_accept)
...
HXLINE( 252)		return s;
 ...
 ::sys::ssl::Certificate Socket_obj::peerCertificate(){
            	HX_GC_STACKFRAME(&_hx_pos_2fd50dee672df425_255_peerCertificate)
...
HX_DEFINE_DYNAMIC_FUNC0(Socket_obj,peerCertificate,return )
 ...
 ::Dynamic Socket_obj::buildSSLConfig(bool server){
            	HX_STACKFRAME(&_hx_pos_2fd50dee672df425_260_buildSSLConfig)
...
HXLINE( 266)		if (::hx::IsNotNull( this->altSNIContexts )) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::sys::ssl::Socket,_gthis) HXARGC(1)
            			 ::Dynamic _hx_run( ::Dynamic servername){
            				HX_STACKFRAME(&_hx_pos_2fd50dee672df425_267_buildSSLConfig)
...
{
{
            	HX_STACKFRAME(&_hx_pos_2fd50dee672df425_120_boot)
